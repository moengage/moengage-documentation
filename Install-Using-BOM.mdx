...
Replace the `<bomVersion>` with the relevant version number. For more information on BOM versions, refer to the [Android SDK release notes](https://developers.moengage.com/hc/en-us/sections/4403887622164-Android-SDK).
...
<Info>
  **Info**
  ...
  To find the latest versions and compatible artifact combinations, please refer to the [Installing SDK using Artifact Id](/hc/en-us/articles/18790373028884).
</Info>
