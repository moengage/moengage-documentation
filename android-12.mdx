...
Ensure to add the configuration in the updated format. For more information, refer to [Exclude MoEngage Storage File from Auto Backup](https://developers.moengage.com/hc/en-us/articles/4401999257236#exclusion-for-api-level-31-or-above-0-2).
