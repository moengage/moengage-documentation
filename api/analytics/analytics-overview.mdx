...
These endpoints return the custom dashboards available to your workspace. Archived dashboards are not returned. For more information on dashboard visibility and sharing, refer to [Custom Dashboards](/user-guide/analyze/dashboards/custom-dashboards).
...
<AccordionGroup>
  ...
  <Accordion title="Why is a dashboard missing from the List Dashboards response?">
    A dashboard is excluded if it is archived or if it is not available to your workspace.
  </Accordion>
