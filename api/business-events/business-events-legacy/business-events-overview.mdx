---
title: "Business Events API (Legacy): Overview"
...
These endpoints remain supported for existing integrations. For new integrations, use the [Business Events API (V5)](/api/business-events/business-events-v5/business-events-v5-overview), which covers triggering and looking up business events through the unified MoEngage gateway. Creating a business event is available only on the legacy API.
