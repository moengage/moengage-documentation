...
<AccordionGroup>
  ...
  <Accordion title="How do I view all events I have created?">
    Use the [Get Business Event API](/api/business-events/get-business-event) with no `name` or `id` parameter to fetch a paginated list of every business event in your workspace. To look up specific events by ID or name instead, use the [Search Business Events API](/api/business-events/search-business-events).
  </Accordion>
</AccordionGroup>
