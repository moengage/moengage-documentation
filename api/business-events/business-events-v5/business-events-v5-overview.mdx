...
Test these endpoints using our pre-configured Postman collection: [View MoEngage Business Events Collection](https://moengage-dev.postman.co/workspace/campaign-core-%23test~1978f696-e3b8-40fb-aaa7-ec4351c4228a/collection/3486165-12d29a30-d61a-43a5-9bd6-186122351ecb). It covers the V5 trigger, list, and search endpoints alongside the legacy Business Events API.
