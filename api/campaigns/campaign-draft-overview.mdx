...
For Campaigns, the key exposes per-resource actions. Select **View** for the read endpoints, **Create & Manage** to create and update campaigns, and **Create, Manage & Publish** to publish them.
