...
- **Same authentication header:** The `MOE-APPKEY` header (your Workspace ID) is used the same way as in V1.
</Note>
...
We have made it easy for you to test the APIs. Click [here](placeholder for postman url) to view the Postman collection.