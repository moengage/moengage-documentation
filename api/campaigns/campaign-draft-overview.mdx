...
<Warning>
**Campaign publishing is not yet supported in V5.** To publish campaigns, use the V1 API (`PATCH /core-services/v1/campaigns/{campaign_id}`) in the interim. Publishing via V5 will be available in a future release.
</Warning>
...
* [Update Campaign](/api/update-campaigns/update-campaign): Updates specific components of an existing draft.
