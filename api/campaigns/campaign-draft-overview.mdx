...
- `API_TRIGGERED` (Email only, early access)
...
This delivery type supports Email only and is in early access. Contact your Customer Success Manager to enable it for your workspace.
</Note>
