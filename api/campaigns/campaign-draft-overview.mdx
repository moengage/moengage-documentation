...
<AccordionGroup>
  ...
  <Accordion title="When should I use API_TRIGGERED instead of EVENT_TRIGGERED?">
    Use `EVENT_TRIGGERED` when MoEngage determines the recipients, based on an event a user performs and the filters you configure. Use `API_TRIGGERED` when your application determines the recipients and names them in the request.
