...
- [Update Campaign](/api/update-campaigns/update-campaign-v1-—-legacy): Updates an existing Push or Email campaign in MoEngage.
...
- [Get Campaign Meta](/api/get-campaign-details/get-campaign-meta-v1-—-legacy): Retrieves campaign details and reachability information for scheduled campaigns.
