...
Test these endpoints using our pre-configured Postman collection: [view here](https://www.postman.com/moengage-dev/api-docs/collection/wssclnq/moengage-content-api-v5?action=share&source=copy-link&creator=3486165).
