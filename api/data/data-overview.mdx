...
| `x-ratelimit-reset` | The number of seconds remaining until the current window resets. Since the window is 60 seconds, this value will always be less than 60. |
