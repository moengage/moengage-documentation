...
All six endpoints resolve the workspace from the Basic Auth credentials in the `Authorization` header. You can send an optional `X-MOE-Request-Id` on any endpoint, and MoEngage echoes it back in the response.
