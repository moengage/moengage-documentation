...
The `X-MOE-Tenant-ID` header (your Workspace ID) is optional — when omitted, the workspace is resolved from the Basic Auth credentials in the `Authorization` header. You can also send an optional `X-MOE-Request-Id`.
...
Test these endpoints quickly using our Postman requests:

- Search Flows: [**View in Postman**](https://www.postman.com/moengage-dev/api-docs/request/uhuxkfc/search-by-flows)
- Get a Single Flow: [**View in Postman**](https://www.postman.com/moengage-dev/api-docs/request/ocz2gf4/get-flow-by-id)
- Get a Specific Version of a Flow: [**View in Postman**](https://www.postman.com/moengage-dev/api-docs/request/97u6hyf/get-flow-by-version-id)
- Update Flow Status: [**View in Postman**](https://www.postman.com/moengage-dev/api-docs/request/sxjei0c/status-update)
