...
keywords: ["MoEngage API", "REST API reference", "API documentation", "API authentication", "Basic Authentication", "data center", "base URL", "rate limits", "error handling"]
icon: "rocket"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Business Events" icon="calendar-check" href="/api/business-events/business-events-v5/business-events-v5-overview">
  ...
  <Card title="Messaging" icon="envelope" href="/api/messaging/messaging-api-overview">
    Trigger email to individual recipients against a reusable campaign shell.
  </Card>
...
| Method | Endpoint | Description |
| --- | --- | --- |
| `POST` | `/v5/campaigns/{campaign_id}/send` | Trigger a message against a campaign shell |
