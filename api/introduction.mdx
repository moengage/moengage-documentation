...
<Note>
  DC-05 (Singapore) is not open for new sign-ups. Workspaces already on DC-05 continue to work, and their API requests still go to `https://api-05.moengage.com`. If you have a data residency requirement for Singapore, contact your Customer Success Manager.
</Note>
