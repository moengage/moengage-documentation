...
The MoEngage REST APIs let you manage user data, campaigns, segments, content, and integrations programmatically, without the dashboard. Every endpoint uses standard HTTP methods, Basic Authentication, and JSON request and response bodies.
