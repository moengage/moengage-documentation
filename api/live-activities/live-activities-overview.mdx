...
<Note>
  Live Activities can only be managed for push campaigns created with the **BROADCAST_LIVE_ACTIVITY** delivery type via the [Create Push Campaigns API](/user-guide/campaigns-and-channels/mobile-push/create/create-push-campaigns). These campaigns cannot be created through the MoEngage UI.
</Note>
