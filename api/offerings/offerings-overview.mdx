...
- [Get Offer Template](/api/public-offerings/get-offer-template): Returns a single template's full field schema and preview HTML by ID, including each field's type, whether it's required, and the valid options for dropdown fields.
...
| `/v5/offers/templates/{template_id}` | GET | 150 requests/min, 500/hour, 1000/day |
