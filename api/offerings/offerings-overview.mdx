...
- [Get Offering](/api/public-offerings/get-offering): Returns a single offering's full configuration by ID, including its content, targeting, scheduling, variation, and capping rules.
...
<AccordionGroup>
  ...
  <Accordion title="Can I fetch a single offering by ID?">
    Yes. Use [Get Offering](/api/public-offerings/get-offering) (`GET /v5/offers/{offer_id}`) to retrieve a single offering's full configuration by ID.
  </Accordion>
</AccordionGroup>
### Create Offering
