...
| `POST /v5/business-events/triggers` — Trigger Business Event (V5) | Campaign triggers: 10 per 5 minutes. Flow triggers: 3 per hour, 10 per day |
...
| Endpoint | Rate limit |
| --- | --- |
| `GET /v5/content-apis` — List Content APIs | 60 requests per minute, 1,000 requests per hour per workspace |
