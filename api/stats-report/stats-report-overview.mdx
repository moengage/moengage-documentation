...
<Note>
Stats and reports are not available for `API_TRIGGERED` campaigns created through the [Messaging API](/api/messaging/messaging-api-overview). Use the reporting that your email provider offers.
</Note>
