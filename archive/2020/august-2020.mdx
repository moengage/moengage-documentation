...
For more information, refer to [Recent Queries](/user-guide/segment/segment-operations/rule-based-filter-segments#recent-queries) and [Understanding Reachability](/user-guide/segment/reachability/user-reachability).