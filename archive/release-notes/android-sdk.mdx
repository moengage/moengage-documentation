...
- Breaking change in integration. Refer to [Push AMP Plus Integration](/developer-guide/android-sdk/push/optional/push-amp-plus/push-amp-plus-integration) for the current setup steps.
- Requires Core version `10.3.00` or above.
