...
- JWT Authentication Support. For more information, refer to [JWT Authentication](https://www.moengage.com/docs/developer-guide/capacitor-sdk/sdk-integration/advanced/jwt-authentication).
- Android
...
| <code>identifyUser(options: &#123; identity: string &#124; Record&lt;string, string&gt;; appId: string &#125;): Promise&lt;void&gt;;</code> |

<Warning>
**Behavior change:** The SDK no longer automatically logs out the previous user when a new user is detected. You must call `logoutUser()` explicitly before identifying a new user.
</Warning>
...
| Then | Now |
| :--- | :--- |
| MoECapacitorCore.setUniqueId() | MoECapacitorCore.identifyUser() |
| MoECapacitorCore.setAlias() | MoECapacitorCore.identifyUser() |
