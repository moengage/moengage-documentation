...
| :-- | :-- | :-- |
| x.x.x | <ul><li><Badge color="green" size="sm">Core</Badge></li><li><Badge color="green" size="sm">InApp</Badge></li><li>RichNotification</li><li>CampaignsCore</li><li>LiveActivity</li><li>Messaging</li><li>Cards</li><li>Inbox</li><li>Geofence</li><li>RealTimeTrigger</li><li><Badge color="green" size="sm">Personalize</Badge></li></ul> | swift = 5.0.0<br />iOS = 13.0<br />tvOS = 13.0 |
...
<span style={{ backgroundColor: '#fff2f0', color: '#cf1322', borderRadius: '12px', border: '1px solid #FFCCC7', fontSize: '0.9em', padding: '3px 10px', fontWeight: 'bold' }}>Fix:</span>
