...
- To configure the Offering Attributes used by this strategy, refer to [Managing Offering Attributes](/user-guide/decisioning/offer-decisioning/managing-offering-attribute).
- To learn how to create a Decision Policy, refer to [Create Decision Policy](/user-guide/decisioning/offer-decisioning/decision-policy#create-decision-policy).
- To assign Offering Attributes to your offerings, refer to [Create Offering Attribute](/user-guide/decisioning/offer-decisioning/create-offering-attribute#create-offering-attribute).