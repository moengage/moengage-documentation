...
To stop the MoEngage SDK from tracking user data to the MoEngage system, use the [disableDataTracking()](https://moengage.github.io/android-api-reference/core/com.moengage.core/disable-data-tracking.html) API.
