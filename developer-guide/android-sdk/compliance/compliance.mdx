---
title: "Compliance"
description: "Enable or disable data tracking and manage user consent in the MoEngage Android SDK."
---

# Enable/Disable Data Tracking

If you don't want the MoEngage SDK not to track user data to the MoEngage System use the [disableDataTracking()](placeholder) API.
...
Once the above API is called, no custom events or user attributes will be tracked. SDK will reject all events until [enableDataTracking()](placeholder) is called.\
...
If you don't want the MoEngage SDK not to track any user information or send any data to the MoEngage System, use the [disableSdk()](placeholder) API.
...
Once this API is called, all the SDK APIs will be non-operational. SDK will be disabled until [enableSdk()](placeholder) is called.\
...
For more information, refer to the [API Documentation.](placeholder)