...
Refer to the API reference of [TrackingOptOutConfig](placeholder) for more details on the available opt-outs. Use the [configureTrackingOptOut()](placeholder) to pass on the configuration to the SDK.
