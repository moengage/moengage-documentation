...
The SDK provides a helper API to track shown events; please refer to the [API documentation](placeholder) for more details.
...
The SDK provides a helper API to track clicked events; refer to the [API documentation](placeholder) for more details.
