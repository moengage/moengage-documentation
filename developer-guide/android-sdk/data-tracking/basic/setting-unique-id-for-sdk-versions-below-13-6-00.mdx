...
description: "Set a unique user ID for login and logout in MoEngage Android SDK versions below 13.6.00."
---
...
<Warning>
  **UNIQUE ID chaos**
  ...
  - If you pass 2 different UNIQUE ID information without calling the [logoutUser](placeholder) method in between, the SDK will internally force the logout of the existing user.
</Warning>
