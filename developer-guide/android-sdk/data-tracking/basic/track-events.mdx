...
<Info>
  **Updated in SDK version X.XX.XX** Public APIs in the Core module now return a `MoETask` object, giving you clear visibility into the success or failure of each operation. For details, see the [release notes](/release-notes/sdks/android#7th-july-2026).
</Info>
