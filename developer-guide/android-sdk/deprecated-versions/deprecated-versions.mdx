...
| 13.05.00 | Supported | TBD | Receives support. |
| 13.04.00 version and below | Deprecated | April 2027 | Support, debugging, and fixes are no longer available. Data continues to flow. Upgrade to the current version. |
