...
Nudges are non-intrusive banners displayed at the edge of the screen without interrupting the user's flow. Like in-apps, nudges support both Native and HTML rendering.

Starting with In-App SDK version 7.0.0, use `showNudge()` to display nudges.
...
<Info>
  This section applies to HTML In-Apps and HTML Nudges only.
</Info>
...
To create a test campaign and verify in-app rendering on a device, refer to [Test your in-app campaign](/user-guide/campaigns-and-channels/in-app-message/create/test-your-in-app-campaign).
