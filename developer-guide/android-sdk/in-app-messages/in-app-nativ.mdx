...
<Info>
  **Updated in SDK version 15.00.00** Public APIs in the InApp module now return a `MoETask` object, giving you clear visibility into the success or failure of each operation. For details, see the [release notes](/release-notes/sdks/android#7th-july-2026).
</Info>
