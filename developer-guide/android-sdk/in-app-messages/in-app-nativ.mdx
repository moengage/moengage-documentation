...
<Warning>
  **Breaking Change (SDK version X.XX.XX)** Public APIs in the InApp module now return a `MoETask` object instead of `void`. Update any code that calls these methods if you want to handle success or failure states. For details, see the [release notes](/release-notes/sdks/android#7th-july-2026).
</Warning>
