...
<Accordion title="Why doesn't <input type='file'> or camera/gallery upload work in HTML In-Apps on Android?">
  - For In-App SDK version 9.6.0 and above, refer to the [WebView Customization](https://www.moengage.com/docs/developer-guide/android-sdk/in-app-messages/in-app-nativ).
