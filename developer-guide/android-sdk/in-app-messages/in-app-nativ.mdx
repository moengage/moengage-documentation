...
This method should be called in the _onResume()_ of your Fragment or _onStart()_ of your activity. The method is asynchronous — the callback is invoked once the payload is available.
