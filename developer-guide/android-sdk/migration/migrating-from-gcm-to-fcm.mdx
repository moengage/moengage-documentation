...
description: "Migrate your Android app from Google Cloud Messaging to Firebase Cloud Messaging for MoEngage push."
---
...
The [latest version](/release-notes/sdks/android) of the MoEngage SDK ships with the Firebase dependency.
...
```Groovy Groovy wrap
implementation ('com.moengage:moe-android-sdk:8.5.00') {
    exclude group: 'com.moengage', module: 'moe-push-firebase'
}
implementation 'com.moengage:moe-push-gcm:2.0.04'
```
...
```Groovy Groovy wrap
dependencies {
    implementation ('com.moengage:moe-android-sdk:7.7.16') {
