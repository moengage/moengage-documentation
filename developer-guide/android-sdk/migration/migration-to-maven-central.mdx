...
description: "Migrate your MoEngage Android SDK dependencies from JCenter to Maven Central."
---
...
Update to the latest SDK version. Because this spans multiple major versions, additional code changes are required beyond the version bump in your `build.gradle`. Step through the migration guides in order:

1. [Updating to 11.x.xx from 10.x.xx](/developer-guide/android-sdk/migration/updating-to-11xxx-from-10xxx)
2. [Updating to 12.x.xx from 11.x.xx](/developer-guide/android-sdk/migration/updating-to-12xxx-from-11xxx)

For the latest version and full version history, see the [Android SDK release notes](/developer-guide/release-notes/android-sdk). Update the other unbundled or dependent MoEngage modules (Push Amp Plus, Push Templates, and so on) to compatible versions as well.
