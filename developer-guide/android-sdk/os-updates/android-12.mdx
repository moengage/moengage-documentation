---
title: "Android 12"
description: "Review Android 12 behavior changes that affect push notifications and deep links in MoEngage campaigns."
---
...
Update the `rich-notification` artifact to the latest version. For the current version, refer to the [Android SDK release notes](/developer-guide/release-notes/android-sdk) or use the [MoEngage BOM](/developer-guide/android-sdk/sdk-integration/basic-integration/Install-Using-BOM), which resolves the version for you. Versions **2.3.00 and later** include the fixes for Android 12; the `rich-notification 4.x` line in the current BOM contains all subsequent updates.
