...
description: "Review MoEngage Android SDK performance benchmarks for initialization time, memory, and battery impact."
---
...
- See [SDK Size Impact](/developer-guide/android-sdk/performance/sdk-size-impact) for per-module APK and AAR size data.
- See [SDK Initialization](/developer-guide/android-sdk/sdk-integration/basic-integration/sdk-initialization) for the recommended initialization pattern.