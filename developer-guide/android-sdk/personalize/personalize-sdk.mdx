...
The `onSuccess` callback returns an [`ExperienceCampaignsResult`](https://moengage.github.io/android-api-reference/personalization-core/com.moengage.campaigns.personalize.model/-experience-campaigns-result/index.html) object containing all necessary metadata for campaign execution in the main thread. Conversely, the `onFailure` callback provides a [`RequestFailureReasonCode` ](https://moengage.github.io/android-api-reference/core/com.moengage.core.model/-request-failure-reason-code/index.html) object. A single response can include both resolved and unresolved keys. Inspect the following properties:
