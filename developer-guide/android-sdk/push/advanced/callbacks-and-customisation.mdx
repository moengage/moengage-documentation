...
To receive a callback whenever a push is clicked, override the [onNotificationClick()](https://moengage.github.io/android-api-reference/pushbase/com.moengage.pushbase.push/-push-message-listener/on-notification-click.html) in the _CustomPushMessageListener_ class created as described in the Notification Received Callback.\
