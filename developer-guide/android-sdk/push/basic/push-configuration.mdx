...
Design the small icon as a single-color silhouette on a transparent background. For more information, refer to the [Android notification guidelines](https://developer.android.com/develop/ui/views/notifications#Templates). Set `notificationColor` to control the color Android applies.
