...
Integration using a Version Catalog is the recommended way of integration. Once you have configured the catalog, add the dependency in the **_app/build.gradle_** file as shown below

<CodeGroup>

```auto build.gradle wrap
dependencies {
     ...
