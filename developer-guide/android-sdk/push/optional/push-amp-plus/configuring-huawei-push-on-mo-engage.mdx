...
description: "Set up Huawei Push Kit callback URLs and HTTPS certificates on the MoEngage Dashboard."
---
...
```python HTTPS certificate generation using Python wrap
import ssl
...
2. Select Huawei (Push Amp+) in the Platforms available on the menu at the top.
   ...
   ![Mceclip0(1)](/images/mceclip0\(1\).png)
...
![Appsecret](/images/appsecret.png)
...
![Appsecret1](/images/appsecret1.png)
