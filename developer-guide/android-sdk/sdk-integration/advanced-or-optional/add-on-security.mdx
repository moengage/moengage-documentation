...
Integration using BOM is the recommended approach; see [Install Using BOM](/developer-guide/android-sdk/sdk-integration/basic-integration/Install-Using-BOM) to configure it if not done already. Once you have configured the BOM, add the dependency in the **_app/build.gradle_** file as shown below.
