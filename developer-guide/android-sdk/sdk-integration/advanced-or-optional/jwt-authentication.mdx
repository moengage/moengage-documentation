...
Register the [**_OnAuthenticationError_**](https://moengage.github.io/android-api-reference/core/com.moengage.core.model.authentication/-on-authentication-error/index.html) listener in a global scope, such as the **_onCreate()_** of your Application class, to ensure your application always receives callbacks.
