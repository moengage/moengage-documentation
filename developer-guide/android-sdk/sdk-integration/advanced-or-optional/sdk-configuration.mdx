...
The following libraries are bundled with the SDK and are available transitively to the consuming app. Be aware of potential version conflicts with these dependencies.
