...
Replace the `<bomVersion>` with the relevant version number. For more information on BOM versions, refer to the [Android SDK release notes](/release-notes/android-sdk/).
