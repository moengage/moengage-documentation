...
description: "Use the MoEngage SDK logger from your dashboard to debug implementation issues without sharing builds."
---
...
<Note>
  The on-device screen that opens here is `MoEDebuggerActivity`, part of the SDK's `sdk-debugger` module. If a security scan flags it as an exported component in a production build, refer to [What is MoEDebuggerActivity?](/developer-guide/android-sdk/troubleshooting-and-faqs/troubleshooting-and-faqs) to understand what it does and how to remove it if needed.
</Note>
