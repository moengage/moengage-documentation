...
description: "Find answers to common MoEngage Android SDK questions about debugging, logging, and integration."
---
...
MoEngage moEngage = new MoEngage.Builder(this, "YOUR_APP_ID", DataCenter.DATA_CENTER_X)
