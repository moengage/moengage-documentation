...
If you are not initializing the SDK in the \*\*\*onCreate()\*\*\*of the Application class please ensure implementing the [IntentPreProcessingListener](https://moengage.github.io/android-api-reference/core/com.moengage.core.listeners/-intent-pre-processing-listener/index.html) and registering this listener using the [registerPreProcessingListener](https://moengage.github.io/android-api-reference/core/com.moengage.core/-mo-e-core-helper/register-pre-processing-listener.html) in the **_onCreate()_** and initialize the SDK in the **_onIntentRecieved()_** of the interface. This is important to process notification clicks when the application is in the killed state.
