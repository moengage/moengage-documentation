...
description: "Troubleshoot issues with MoEngage in-app messages not rendering or displaying correctly on Android."
---
...
3. In-apps are NOT synced to the device because of lifecycle library integration problems. Use the steps given [here](/developer-guide/android-sdk/troubleshooting-and-faqs/troubleshooting-and-faqs) to troubleshoot them.
