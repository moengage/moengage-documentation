...
To read the identifiers currently set for the user, call `getUserIdentities()`. Available from SDK 7.0.0, it resolves to an object of identifier names and their values. The object is empty when no identifiers are set for the user.
