...
| --- | --- | --- | --- |
| Core 7.x | Current | TBD | Latest major version. Receives new features, fixes, and full support. |
| Core 6.x | Supported | TBD | Receives critical fixes and support. |
| Core 5.x and below | Deprecated | TBD | Support, debugging, and fixes are no longer available. Data continues to flow. Upgrade to the current or a supported version. |
