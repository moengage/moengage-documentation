...
<Note>
  **Prerequisites**
  ...
  - Your application must use the MoEngage Capacitor SDK version [**_7.1.0_** ](/release-notes/sdks/capacitor#core-7-1-0)  or higher to access the JWT authentication feature.
