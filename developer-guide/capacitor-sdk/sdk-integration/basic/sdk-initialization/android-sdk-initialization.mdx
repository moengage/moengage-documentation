...
<Info>
  You can also configure the SDK using native configuration files instead of code. See [File-based Initialization](/developer-guide/capacitor-sdk/sdk-integration/basic/sdk-initialization/file-based-initlialization/file-based-initialization).
</Info>
