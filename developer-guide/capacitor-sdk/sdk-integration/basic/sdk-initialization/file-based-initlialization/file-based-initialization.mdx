...
<Info>
  Starting with [v7.0.0.](/release-notes/sdks/capacitor#core-7-0-0), the MoEngage Capacitor SDK supports file-based initialization.
</Info>
...
3. Click **Generate** at the bottom of the form.
...
<Accordion title="iOS Configurations">
  ...
  |  | `DataCenter` | Integer | Specifies the Data Center value. This is a Mandatory field. The default value is _1_. For more info, refer to [Data Center values](#data-center-values). |
...
To migrate from manual code-based initialization to the file-based approach, refer [here](/developer-guide/capacitor-sdk/sdk-integration/basic/sdk-initialization/file-based-initlialization/migration-and-precedence).
...
- [Android SDK Initialization](/developer-guide/capacitor-sdk/sdk-integration/basic/sdk-initialization/android-sdk-initialization)
- [iOS SDK Initialization](/developer-guide/capacitor-sdk/sdk-integration/basic/sdk-initialization/ios-sdk-initialization)
