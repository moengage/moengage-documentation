...
Before initializing the SDK from JavaScript, initialise the native module in your Android Application class. Add the following to `android/app/src/main/java\<your_package\>/MainApplication.java (or .kt)`  inside `onCreate()`. 
