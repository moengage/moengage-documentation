...
<Accordion title="Android Configuration">
  ...
  | :-- | :-- | :-- | :-- |
  | **Core** | `com_moengage_core_workspace_id` | String | Specifies YOUR_WORKSPACE_ID. This field is mandatory. |
...
<Accordion title="iOS Configurations">
  ...
  | :-- | :-- | :-- | :-- |
  | **Core** | `WorkspaceId` | String | Specifies YOUR_WORKSPACE_ID. It is a Mandatory field. |
