...
<Tip>
  For setup steps for other clients — such as Claude Code and Claude Desktop — and a full list of the tools the docs MCP server exposes, see [Documentation Access to Agents](/documentation-access-to-agents).
</Tip>
