...
<Info>
  From [Core 10.1.0](/release-notes/sdks/cordova#core-10-1-0) onwards, you can configure the SDK through `Info.plist` again. Refer to [File-Based Initialization](/developer-guide/cordova-sdk/sdk-integration/sdk-initialization/file-based-initialization/file-based-initialization).
</Info>
