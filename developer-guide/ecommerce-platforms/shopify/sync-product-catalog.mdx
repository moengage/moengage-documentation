...
**[SCREENSHOT PLACEHOLDER: Sync product catalog tab showing the catalog name, the attribute mapping table, and the currency selection]**
...
**[SCREENSHOT PLACEHOLDER: Add custom attributes field with a name entered, a data type selected, and the Add attribute button]**
...
**[SCREENSHOT PLACEHOLDER: Catalog sync confirmation dialog stating that attributes, Shopify source, and currency can be configured only once]**
