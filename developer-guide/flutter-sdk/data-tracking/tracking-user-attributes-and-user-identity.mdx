...
You enable and disable the SDK and data tracking in the native layer. For more information, refer to:

- [Compliance (Android SDK)](/developer-guide/android-sdk/compliance/compliance)
- [Compliance (iOS SDK)](/developer-guide/ios-sdk/compliance/compliance)
