...
To read the identifiers currently set for the user, call `getUserIdentities()`. Available from plugin version 9.2.0, it returns a map of identifier names to their values, or `null` if the identifiers could not be read.
