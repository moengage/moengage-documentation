...
| Core 7.2.0 and above | Supported | TBD | Receives support. |
| Core 7.1.1 and below | Deprecated | August 2027 | Support, debugging, and fixes are no longer available. Data continues to flow. Upgrade to the current version. |
