...
<Note>
  Review the [SDK Deprecation Policy](/developer-guide/sdk-lifecycle-and-policies/sdk-deprecation-policy) for supported SDK versions and deprecation timelines before integrating.
</Note>
