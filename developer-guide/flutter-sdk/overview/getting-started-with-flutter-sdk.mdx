...
Initialize an instance of the MoEngage plugin by calling the [Framework Initialization](/developer-guide/flutter-sdk/sdk-integration/sdk-initialization/manual-initialization/framework-initialization) method.
...
- **Tracking user attributes** - To set custom attributes available in the user profile, refer to the methods in [this article](/developer-guide/flutter-sdk/data-tracking/tracking-user-attributes-and-user-identity).
