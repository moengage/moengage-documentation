...
- **SDK initialization:** Initialize the MoEngage SDK using [file-based initialization](/developer-guide/flutter-sdk/sdk-integration/sdk-initialization/file-based-initialization).
  - **App Group configuration:** Provide the `AppGroupName` key (for example, `group.com.organization.app`) you are using with `sdkConfig.appGroupID`.
      <Frame>
        <img
          src="/images/iOS.png"
          alt="I OS"
...
<Frame>
  <img
    src="/images/newrunscriptphase-2.png"
    alt="Newrunscriptphase 2"
    title="Newrunscriptphase 2"
    style={{ width:"58%" }}
  />
</Frame>
...
<Frame>
  <img
    src="/images/removeexistingextensions-1.png"
    alt="Removeexistingextensions 1"
    title="Removeexistingextensions 1"
    style={{ width:"54%" }}
  />
</Frame>
