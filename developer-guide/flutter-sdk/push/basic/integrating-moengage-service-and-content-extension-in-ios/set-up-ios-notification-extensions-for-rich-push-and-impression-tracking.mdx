...
To migrate from an existing manual implementation to the integrator tool, refer [here](/developer-guide/flutter-sdk/push/basic/integrating-moengage-service-and-content-extension-in-ios/migrating-to-the-extension-integrator-tool).
