...
<Tip>
  **Prerequisites**
  ...
  - Ensure you are using MoEngage Flutter SDK version [10.6.0](https://www.moengage.com/docs/developer-guide/release-notes/flutter-sdk/changelog-6#core-10-6-0) or above to utilize the extension integrator tool.
...
3. **Generate provisioning profile:** On the [Apple Developer Portal](https://developer.apple.com/account/resources/profiles/list), create a new provisioning profile for the identifier created in step 1, download it, and double-click to register it in Xcode.
   <Frame>
     <img
       ...
       alt="Provisioningprofile 2"
       title="Provisioningprofile 2"
       style={{ width:"49%" }}
     />
   </Frame>
...
<Frame>
  <img
    alt="Provisioningprofile 1"
    title="Provisioningprofile 1"
    style={{ width:"65%" }}
