...
<Steps>
  <Step title="Get YOUR_WORKSPACE_ID">
  ...
  <Step title="Initialize the SDK">
    Call the initialization method with YOUR_WORKSPACE_ID and data center. Use the **TEST** environment during development and **LIVE** for production.
  </Step>
