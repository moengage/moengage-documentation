...
keywords: ["MoEngage SDK", "SDK integration", "integration guide", "iOS SDK", "Android SDK", "Web SDK", "React Native SDK", "Flutter SDK", "event tracking", "push token registration"]
---
...
<CardGroup cols={3}>
  ...
  <Card title="Capacitor" icon="bolt" href="/developer-guide/capacitor-sdk/sdk-integration/basic/sdk-installation/framework-dependency">
...
| --- | --- | --- | --- | --- |
| **Android** | Kotlin, Java | API 23 (Android 6.0), compileSdk 36 | Maven Central | [BOM (recommended)](/developer-guide/android-sdk/sdk-integration/basic-integration/Install-Using-BOM) |
...
| **Capacitor** | TypeScript \+ native | Capacitor 3\+ (inherits native minimums) | npm | [Capacitor guide](/developer-guide/capacitor-sdk/sdk-integration/basic/sdk-installation/framework-dependency) |
...
| Validate SDK integration | [Integration Validation](/user-guide/getting-started/integration-validation/android-native-integration-validation) | [Release Checklist](/developer-guide/ios-sdk/checklist/release-checklist) | [MoEngage Assist Chrome Extension](/developer-guide/web-sdk/integration-validation/moengage-assist-chrome-extension) |

## Upgrading & Migration

<CardGroup cols={2}>
  <Card title="Android Migration Guides" icon="arrow-up">
    [10.x → 11.x](/developer-guide/android-sdk/migration/updating-to-11xxx-from-10xxx) · [11.x → 12.x](/developer-guide/android-sdk/migration/updating-to-12xxx-from-11xxx) · [Manifest → Code-based init](/developer-guide/android-sdk/migration/moving-from-manifest-to-code-based-integration) · [Maven Central migration](/developer-guide/android-sdk/migration/migration-to-maven-central)
  </Card>
...
<CardGroup cols={3}>
  ...
  <Card title="Troubleshooting" icon="wrench">
    [Android](/developer-guide/android-sdk/troubleshooting-and-faqs/troubleshooting-and-faqs) · [iOS](/developer-guide/ios-sdk/troubleshooting-and-faqs/troubleshooting-and-faqs-ios) · [React Native](/developer-guide/react-native-sdk/troubleshooting-and-faqs/troubleshooting-and-faqs-react) · [Flutter](/developer-guide/flutter-sdk/troubleshooting-and-faqs/troubleshooting-and-faqs-flutter) · [Capacitor](/developer-guide/capacitor-sdk/troubleshooting-and-faqs/troubleshooting-and-faqs-capacitor)
  </Card>
