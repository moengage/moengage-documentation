...
- We have released an SDK update (MORichNotification [5.2.0](/developer-guide/release-notes/ios-sdk)) to have the current layout of Push template notifications similar to the native notification layout of iOS 15.
