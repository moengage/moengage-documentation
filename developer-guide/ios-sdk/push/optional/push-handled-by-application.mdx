...
<Note>
  If you have configured a [Notification Service Extension](/developer-guide/ios-sdk/push/basic/ios-push-integration-tutorial#step-1-implement-notification-service-extension-nse), the SDK tracks impressions from the extension for all display notifications, both text-only and rich. You don't need to call `logNotificationReceived(withPayload:)` for these notifications.
