...
Templates that display an image, audio, or video depend on the Notification Service Extension to download the asset. For the transport, format, and size requirements that apply to that download, see [Media Requirements](/developer-guide/ios-sdk/push/basic/ios-push-integration-tutorial#media-requirements).
