...
The Notification Service Extension downloads the image, audio, or video used in a template. Refer to [Media Requirements](/developer-guide/ios-sdk/push/basic/ios-push-integration-tutorial#media-requirements) for the transport, format, and size requirements.
