...
For example, if the dashboard URL starts with https://dashboard-01.moengage.com, your current version of Web SDK is 2, and workspace_id is YOUR_WORKSPACE_ID,  then the prefetch and initiation code would be:
...
For example, if the dashboard URL starts with https://dashboard-01.moengage.com, your current version of Web SDK is 2, and workspace_id is YOUR_WORKSPACE_ID,  then the whole code will look like:
...
For example, if the dashboard URL starts with https://dashboard-01.moengage.com, and workspace_id is YOUR_WORKSPACE_ID,  then the prefetch and initiation code would be:
