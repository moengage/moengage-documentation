...
To read the identifiers currently set for the user, call `getUserIdentities()`. It resolves to an object of identifier names and their values, or `null` if the identifiers could not be read.
