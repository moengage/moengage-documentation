...
<Info>
  You can now get notified whenever MoEngage releases a new version of the React Native SDK. For more information, refer to [Subscribe to MoEngage SDK Releases](/release-notes/sdks/react-native).
</Info>
