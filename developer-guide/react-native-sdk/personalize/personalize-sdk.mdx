...
{/* Consider adding what will happen if meta is not called or called with different status and expected payload key is not under that status. Similar to Android */}
...
{/* We can consider adding a common section across all personalized doc which shows the payload for campaigns. More details on Android doc comment */}
