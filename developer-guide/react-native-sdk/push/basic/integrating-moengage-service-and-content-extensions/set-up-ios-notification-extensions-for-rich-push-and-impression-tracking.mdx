...
3. **Generate provisioning profile:** On the [Apple Developer Portal](https://developer.apple.com/account/resources/profiles/list), create a new provisioning profile for the identifier created in step 1, and download it. To register it in Xcode, click **Xcode** in the menu bar, choose **Settings**, switch to the **Apple Accounts** section, and click on your Apple developer account.
   <Frame>
     <img
