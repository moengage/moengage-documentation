...
To migrate from an existing manual implementation to the integrator tool, refer [here](/developer-guide/react-native-sdk/push/basic/integrating-moengage-service-and-content-extensions/migrating-to-the-extension-integrator-tool).
...
<AccordionGroup>
  <Accordion title="The integrator tool returned an error. How do I resolve it?">
    ...
    - **Incorrect Integration:** The setup does not follow the [Integrating Service & Content Extension](/developer-guide/ios-sdk/push/basic/ios-push-integration-tutorial) guide.
