...
| Rich media in push (images, GIFs, video) | ✅ Required | — | — | (default) |
...
<Info>
  If you already have an existing Notification Service Extension, you can pass your existing extension’s name using the `--notification-service-extension-name` flag in the Run Script phase. The tool will then inject the necessary MoEngage logic into your current implementation without overwriting your custom code.
</Info>
