...
<Info>
  You can also configure the SDK using native configuration files instead of code. See [File-based Initialization](/developer-guide/react-native-sdk/sdk-integration/react-native/sdk-initialization/file-based-initialization/file-based-initialization).
</Info>
