...
<div style={{ border: '1px solid #E8E8E8', borderRadius: '8px', padding: '16px' }}>
  ...
  | :-------------- | :---------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------- |
  | [x.x.x]()       | [x.x.x]()   | •<span style={{ color: '#008767', fontWeight: 'bold' }}> moe-android-sdk: xx.xx.x </span><br />• inapp: 10.2.0<br />• push-amp: 6.5.0<br />• realtime-trigger: 4.5.0<br />• cards-core: 3.5.0<br />• cards-ui: 3.5.0<br />• geofence: 5.4.0<br />• richNotification: 6.6.0<br />• inbox:4.5.0 <br />• pushkit: 6.5.0<br />• inbox-ui: 4.5.0<br /> • personalization: 1.0.1<br /> • security: 4.4.0<br /> •encryptedStorage: 3.4.0 | AGP: 8.13.2<br />Kotlin: 1.9.23<br />Compile SDK Version: 34<br />Gradle Version: 8.13 |
</div>
