...
<Info>
  For privacy manifest support on iOS, please make sure that you are on Cordova SDK Version 8.6.0 or above and iOS SDK Version 9.16.2 or above. Want to know more about privacy manifest ? Refer this [link](https://www.moengage.com/docs/user-guide/data/privacy/apple-privacy-manifest-update)
</Info>
