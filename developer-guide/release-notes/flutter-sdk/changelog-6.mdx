...
| --- | --- |
| core: 10.8.0  <br />cards: 6.6.0<br />inbox: 9.6.0 <br />geofence: 6.6.0<br />Personalize: 1.1.0 | AGP: 8.13.2   <br />Kotlin: 1.9.23   <br />Compile SDK Version: 35   <br />Gradle Version: 8.9   Min SDK version: 23 |
...
- Android
  - Added support for the logout complete listener.
- iOS
  - Added support for the logout complete listener.
...
- Android
  - Resolved a limitation in the build toolchain to allow SDK compilation using the recommended JDK 17, removing the strict JDK 19 dependency.
