...
- iOS
  - Updated MoEngage-iOS-SDK to **_10.11.0_**
...
| **Plugins** | **Android Dependencies** |
| --- | --- |
| core: 10.6.0   <br />cards:6.4.0  <br /> inbox:9.4.0  <br /> geofence:6.4.0 | AGP: 8.13.2   <br />Kotlin: 1.9.23   <br />Compile SDK Version: 35   <br />Gradle Version: 8.9   Min SDK version: 23 |
...
- Android
  ...
  - Mi SDK update to Version 5.x.x, refer to the [Configuring Xiaomi Push](https://developers.moengage.com/hc/en-us/articles/4403466194708)).
