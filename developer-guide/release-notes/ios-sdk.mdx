...
<Warning>
**Deprecation Warning**
- `disableBadgeReset()` and `disableBadgeReset(_ disable:)` in MoEngageSDKMessaging are deprecated as of 10.13.0. MoEngage recommends you to use `MoEngageBadgeUpdateEnabled` in `Info.plist` instead. For more information, refer to [Disable Badge Reset](https://www.moengage.com/docs/developer-guide/ios-sdk/push/advanced/custom-notification-handling#disable-badge-reset). 
</Warning>
