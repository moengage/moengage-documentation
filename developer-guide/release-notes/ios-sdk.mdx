...
| :-- | :-- | :-- |
| 10.13.0 | <ul><li><Badge color="green" size="sm">Core</Badge></li><li>InApp</li><li>RichNotification</li><li>CampaignsCore</li><li>LiveActivity</li><li>Messaging</li><li>Cards</li><li>Inbox</li><li>Geofence</li><li>RealTimeTrigger</li><li>Personalize</li></ul> | swift = 5.0.0<br />iOS = 13.0<br />tvOS = 13.0 |
