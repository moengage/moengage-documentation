...
| --- | --- |
| core: x.x.x   <br />cards: x.x.x  <br />geofence: x.x.x  <br /> inbox: x.x.x<br />personalize: 1.0.0 | <ul><li>**Android** <ul><li>AGP: 8.13.2</li><li>Kotlin: 1.9.23</li><li>Compile SDK Version: 35</li><li>Gradle Version: 8.13</li></ul></li><li>**iOS** <ul><li>iOS deployment target: 13</li><li>tvOS deployment target: 13</li></ul></li></ul> |

# Personalize 1.0.0

### **What's New**

Personalization: Introducing the MoEngage Personalize SDK, a framework to fetch personalized campaign content and track user impressions and clicks at both the campaign and individual offering levels. For more information, refer to Personalize SDK.
