...
| --- | --- |
| core: 12.7.0   <br />cards: 6.5.0  <br />geofence: 7.4.0  <br /> inbox: 6.4.0<br />personalize: 1.0.1 | <ul><li>**Android** <ul><li>AGP: 8.13.2</li><li>Kotlin: 1.9.23</li><li>Compile SDK Version: 35</li><li>Gradle Version: 8.13</li></ul></li><li>**iOS** <ul><li>iOS deployment target: 13</li><li>tvOS deployment target: 13</li></ul></li></ul> |

# Personalize 1.0.1

### Fixes

- Fixed an incorrect internal dependency version in the Personalize module that caused build failures. Upgrade recommended if you use the Personalize plugin.
