...
- Web SDK Assist: Introduced the MoEngage Assist Chrome Extension, a dedicated browser tool designed to seamlessly debug your Web SDK integration, inspect live event payloads, and troubleshoot campaigns in real time. For more info, refer [here](developer-guide/web-sdk/other-supported-web-sdk-integration/moengage-assist-chrome-extension).
