...
As an alternative to programmatic initialization, you can initialize the SDK using a configuration file. Create `moengage_init_config.xml` in your Android library plugin at `Assets/Plugins/Android/<YOUR_ANDROID_LIBRARY_PLUGIN>.androidlib/res/values/moengage_init_config.xml` and specify YOUR_WORKSPACE_ID and data center:
