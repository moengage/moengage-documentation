...
| 2.31.x | Supported | TBD | Receives support. |
| 2.30.00 and below | Deprecated | April 2027 | Support, debugging, and fixes are no longer available. Data continues to flow. Upgrade to the current version. |
