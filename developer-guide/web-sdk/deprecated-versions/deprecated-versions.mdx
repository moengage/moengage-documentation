...
| 2.31.x and above | Supported | TBD | Receives support. |
| 2.30.00 and below | Deprecated | August 2027 | Support, debugging, and fixes are no longer available. Data continues to flow. Upgrade to the current version. |
