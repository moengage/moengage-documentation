...
Create a custom wrapper hook [`useMoEngage.js`](https://github.com/moengage/webSDK-sample/blob/master/ChatGPT-App/src/client/hooks/useMoEngage.js) to cleanly manage initialization and expose SDK methods throughout your widget.
...
The [`handleToolResult`](https://github.com/moengage/webSDK-sample/blob/master/ChatGPT-App/src/client/components/App.jsx) callback acts as the central event dispatcher. MoEngage SDK methods can be triggered in two ways:
...
Use the  [`handleToolResult`](https://github.com/moengage/webSDK-sample/blob/master/ChatGPT-App/src/client/components/App.jsx) callback to catch incoming postMessage commands from the MCP server and route them to the appropriate MoEngage SDK wrapper functions.
...
For a complete, practical demonstration of this integration within a fully functional environment,  refer to the [Sample Application](https://github.com/moengage/webSDK-sample/tree/master/ChatGPT-App).