...
keywords: "cookie lifetime, cookie expiry, web sdk cookie duration, how long cookies last"
---
...
<Note>
  MoEngage Web SDK cookies expire 2 years after they are set.
</Note>

## Disable all Cookies

If you want that Moengage SDK does not set or use any cookies, then you can do it by passing `disableCookies` while [initialising the SDK](/developer-guide/web-sdk/web-sdk-integration/basic-integration/web-sdk-integration) as:
