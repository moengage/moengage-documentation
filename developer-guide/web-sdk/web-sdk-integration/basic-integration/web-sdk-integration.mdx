...
### Does the MoEngage Web SDK support Angular applications using Zone.js?

Yes. For Angular applications using Zone.js, MoEngage recommends enabling Native Browser API Support. Zone.js patches native browser APIs such as `Promise`, `setTimeout`, and `MutationObserver`, which can cause inconsistent SDK behavior.
