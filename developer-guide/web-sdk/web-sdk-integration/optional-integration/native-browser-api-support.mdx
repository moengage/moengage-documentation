...
description: "Integrate Native Browser API Support for the MoEngage Web SDK in applications that patch or override native browser APIs."
---
...
To pin the script to a specific SDK version, replace `latest` in the URL with the target version number.
...
<Note>
  This check is only indicative. Browser behavior may vary. If the output shows wrapped or custom implementations, MoEngage recommends enabling Native Browser API Support regardless.
</Note>
