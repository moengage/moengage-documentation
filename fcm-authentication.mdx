...
7. Download the JSON file and upload it to the MoEngage Dashboard at **Settings** \> **Channel** \> **Push** \> **App Push** \> **Android** \> **FCM Authentication** \> **Private key file (Recommended)**\
   <img src="25961030365972" />
8. After the JSON is configured, enable FCM in the [cloud console](https://console.cloud.google.com/apis/library/fcm.googleapis.com). <img src="17149564003348" alt="EnableFCM.png" />
...
To check your current limit, go to [Google Cloud console](https://console.cloud.google.com/) \> APIs & Services \> Firebase Cloud Messaging API \> Quotas & System Limits or directly to [FCM Quotas](https://console.cloud.google.com/apis/api/fcm.googleapis.com/quotas) and see the value for Send requests per minute.

To request a rate limit increase beyond 600,000 RPM, [contact Firebase Support](https://firebase.google.com/support).
