...
3. Select **Project settings**. <img src="16909990244372" alt="FCM_Step1.png" />
4. On the **Project Settings** page, navigate to the **Service accounts** tab. <img src="17149564002196" alt="FirebaseAdminSDK.png" />
...
7. Download the JSON file and upload it to the MoEngage Dashboard at **Settings** \> **Channel** \> **Push** \> **App Push** \> **Android** \> **FCM Authentication** \> **Private key file (Recommended)**\\
   ...
   ![](25961030365972)
8. After the JSON is configured, enable FCM in the [cloud console](https://console.cloud.google.com/apis/library/fcm.googleapis.com).[Placeholder_Link] <img src="17149564003348" alt="EnableFCM.png" />
