...
Refer to the updated [MoEngage's default Notification Center](/developer-guide/android-sdk/push/optional/notification-center) for details on how to use the default UI and possible customization.
...
Refer to the [Self Handled Notification Center](/developer-guide/android-sdk/push/optional/notification-center) for updated APIs
