...
Update to the latest SDK version `11.0.04` or above. Since it would be a major version update there might be additional code changes required apart from changing the version number in your gradle file(s). Refer to the [Updating to 11.x.xx](https://developers.moengage.com/hc/en-us/articles/4403899650196) document and [Release Notes](https://developers.moengage.com/hc/en-us/articles/4403896795540) for more details.  
Make sure you update the other unbundled/dependent MoEngage SDKs or modules(like Push Amp Plus, Push Templates, etc.) to the compatible version.
...
Update to the latest SDK version `5.1.00` or above. Since it would be a major version update there might be additional code changes required apart from changing the version number in your gradle file(s). Refer to the [Updating to 11.x.xx](https://developers.moengage.com/hc/en-us/articles/4403899650196) document and [Release Notes](https://developers.moengage.com/hc/en-us/articles/4403896795540) for more details.  
Make sure you update the other unbundled/dependent MoEngage SDKs or modules(like Push Amp Plus, Push Templates, etc.) to the compatible version.
