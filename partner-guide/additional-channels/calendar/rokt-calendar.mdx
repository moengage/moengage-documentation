...
You can refer to [Rokt Calendar Event APIs here ](https://roktcalendar-api.readme.io/reference/create-new-subscription-event)
...
You can refer to [Rokt Calendar Event APIs here ](https://roktcalendar-api.readme.io/reference/update-subscription-event)
