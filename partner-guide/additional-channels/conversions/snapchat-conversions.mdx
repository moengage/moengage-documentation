...
6. Enter the following details:
   ...
   | Access Token | Yes | This is the permanent access token generated in Snapchat Ads Manager (from [Step 1.2)](#step-12-generate-a-permanent-access-token). |
   | Pixel ID | Yes | Your unique Snapchat Pixel ID (retrieved in [Step 1.1](#step-11-retrieve-the-snapchat-pixel-id)). |
...
Follow the same process as the Web Conversions setup to retrieve your Pixel ID (from [Step 1.1](#step-11-retrieve-the-snapchat-pixel-id)) and Access Token (from [Step 1.2](#step-12-generate-a-permanent-access-token)).
