...
5. Click the  ![Click the arrow and then select one of the following options](/images/partner_41667663675412.png)   arrow and then select one of the following options:
   - **Create Audience**
...
7. Click **Connect**.
   ![Screenshot 2026-03-31 at 3.05.51 PM.png](/images/partner_47757046469652.png)
8. You will be directed to the Microsoft login page to authorize your account.
9. Log in using an account with Administrator privileges to grant MoEngage the necessary permissions to establish the connection.
   ![Screenshot 2026-03-31 at 3.49.13 PM.png](/images/partner_47757476341396.png)
...
3. Run a test campaign and review the response.
   ![Test campaign response showing the Audience ID for a Microsoft Advertising Customer List](/images/partner_47757046470420.png)
...
<Tabs>
  ...
  <Tab title="Update Users to Audience">
    ...
    | Select Identifier | Yes | Select the type of user identifier to match against Microsoft Advertising. Options are:  - Email - Phone - CRM ID **Note**: All identifiers are SHA-256 hashed before being sent to Microsoft Advertising. |
...
1. Your campaign is now ready to test and send. Using the Test functionality, you can also test your connector configuration.
   ![Test a Microsoft Advertising audience campaign before publishing](/images/partner_41668254724244.png)
