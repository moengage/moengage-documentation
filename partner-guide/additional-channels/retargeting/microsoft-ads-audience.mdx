...
description: "Sync MoEngage audience segments to Microsoft Ads to power targeted advertising and retargeting campaigns."
---
...
1. 1. 1. Log in to your [Microsoft Advertising account](https://ads.microsoft.com/).
  ...
  **Information**
  ...
  - The Client ID, Client Secret, and Developer Token are all required to set up the integration in the MoEngage App Marketplace.
         ...
         ![Screenshot 2026-03-31 at 3.17.09 PM.png](/images/partner_47757046468116.png)
...
3. Run a test campaign and review the response.
   ![Screenshot 2026-03-31 at 3.20.40 PM.png](/images/partner_47757046470420.png)
4. The highlighted ID is your Audience ID. Use it to add or remove users from this Audience List. You can find this ID in the Microsoft Advertising account by following the [steps above](#update-to-an-existing-customer-list-on-microsoft-advertising):
  ...
  **Warning**
  ...
  Do not publish this campaign; it creates multiple Customer Lists with the same name on Microsoft Advertising.
   ...
   ![Screenshot 2026-03-31 at 2.55.08 PM.png](/images/partner_47757046471060.png)
   ...
   ![Screenshot 2026-03-31 at 2.56.48 PM.png](/images/partner_47757038211988.png)
5. Your campaign is now ready to test and send your campaign. Using the Test functionality, you can also test your connector configuration.![Your campaign is now ready to test and send your campaign. Using the Test functionality, you can also test you](/images/partner_41668254724244.png)
