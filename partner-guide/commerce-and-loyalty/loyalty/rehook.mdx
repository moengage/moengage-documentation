...
<Info>
  **Prerequisites**
  ...
  - You would need to know your Rehook [API Key and Secret Key](https://rehook.readme.io/reference/getting-started-copy).
</Info>
...
- Refer to the [Rehook API documentation](https://rehook.readme.io/reference/getting-started-copy) for more information.
...
To forward MoEngage users to Rehook, or update their properties on Rehook, set up a MoEngage Connector Campaign as shown above and use the [Rehook's Create or Update API](https://rehook.readme.io/reference/create-customer) to create or update users inside Rehook.
...
To display your customers' reward progress, use Rehook's [Get Reward Progress API](https://rehook.readme.io/reference/get-reward-progress).
