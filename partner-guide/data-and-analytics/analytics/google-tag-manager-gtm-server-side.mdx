...
You can leave this section as it is. If you're using a Snowplow client, we have additional options that you can use to ingest Snowplow events into MoEngage. Read more about this in our [Snowplow integration guide](/partner-guide/data-and-analytics/analytics/snowplow).
