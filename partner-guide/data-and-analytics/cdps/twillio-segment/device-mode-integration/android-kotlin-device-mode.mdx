...
Generate an FCM private key in the Firebase console and upload it to the MoEngage Dashboard along with your package name. For the steps to generate the key and where to upload it, see [FCM Authentication](/developer-guide/android-sdk/push/basic/fcm-authentication).
