...
<Warning>
  This SDK built on top of [analytics-ios](https://github.com/segmentio/analytics-ios) will no longer receive updates. We recommend you use the [MoEngage-Segment-Swift](https://github.com/moengage/MoEngage-Segment-Swift) SDK built on top of [analytics-swift](https://github.com/segmentio/analytics-swift). Refer to the [MoEngage-Segment-Swift documentation](/partner-guide/data-and-analytics/cdps/twillio-segment/device-mode-integration/ios-swift-device-mode) for more details.
</Warning>
