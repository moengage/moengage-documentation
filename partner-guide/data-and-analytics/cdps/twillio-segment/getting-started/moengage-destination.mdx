...
With MoEngage Destination on Twilio Segment, you can forward your Users, Events, and Audiences ([Twilio Segment Engage](/partner-guide/data-and-analytics/cdps/twillio-segment/getting-started/twilio-segment-engage)) data to MoEngage and run personalized campaigns targeting them. If you’re a new MoEngage customer, you can relay historical data to MoEngage using [Twilio Segment replays](/partner-guide/data-and-analytics/cdps/twillio-segment/getting-started/twilio-segment-engage).
...
<Tabs>
  <Tab title="MoEngage (Classic)">
    ...
    | --- | --- | --- |
    | Preferred | [Analytics Swift](https://github.com/segmentio/analytics-swift) | [MoEngage Segment Swift](/partner-guide/data-and-analytics/cdps/twillio-segment/device-mode-integration/ios-swift-device-mode) |
    | Legacy | [Analytics iOS](https://github.com/segmentio/analytics-ios) | [MoEngage Segment iOS](/partner-guide/data-and-analytics/cdps/twillio-segment/device-mode-integration/ios-swift-device-mode) |
    ...
    |  | Segment SDK | MoEngage SDK |
    | --- | --- | --- |
    | Preferred | [Analytics Kotlin](https://github.com/segmentio/analytics-kotlin) | [MoEngage Segment Kotlin](/partner-guide/data-and-analytics/cdps/twillio-segment/device-mode-integration/android-kotlin-device-mode) |
    | Legacy | [Analytics Android](https://github.com/segmentio/analytics-android) | [MoEngage Segment Android](/partner-guide/data-and-analytics/cdps/twillio-segment/device-mode-integration/android-device-mode) |

    ### Web

    To complete the side-by-side integration, please refer to the detailed instructions for [Segment Web](/partner-guide/data-and-analytics/cdps/twillio-segment/device-mode-integration/web-device-mode).

    ### React Native

    To complete the side-by-side integration, please refer to the detailed instructions for [Segment React Native](/partner-guide/data-and-analytics/cdps/twillio-segment/device-mode-integration).
  </Tab>
...
Using Segment Engage, you can create segments of users based on data you have already collected across various sources and sync them to MoEngage. For more information, refer to how to set up and sync [Segment Personas and Computed Traits](/partner-guide/data-and-analytics/cdps/twillio-segment/getting-started/twilio-segment-engage).
...
<PartnerRateLimit partner="Segment" />
