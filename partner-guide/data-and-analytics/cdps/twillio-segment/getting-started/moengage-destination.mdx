...
<Tabs>
  ...
  <Tab title="MoEngage (Actions)">
    ...
    For more information, refer to [Portfolio](/user-guide/settings/account/portfolio/portfolio) and [Portfolio: Data Ingestion and Management](https://www.moengage.com/docs/user-guide/data/key-concepts/portfolio-data-ingestion-and-management#event-properties-project-level).
