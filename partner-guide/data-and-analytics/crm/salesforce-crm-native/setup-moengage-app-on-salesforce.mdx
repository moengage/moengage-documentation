...
<Info>
  This integration is part of the Salesforce CRM add-on. To check what's available for your plan, refer to [Plans and Pricing](https://www.moengage.com/plans-and-pricing/). To enable it for your account, contact your MoEngage Customer Success Manager (CSM) or the Support team.
</Info>
...
<CardGroup cols={2}>
  <Card title="Sync Salesforce objects to MoEngage" icon="arrow-right-to-bracket" href="/partner-guide/data-and-analytics/crm/salesforce-crm-native/sync-salesforce-objects-to-moengage">
    Sync any Salesforce object to MoEngage as users or events. Newly created or updated records sync in real time.
  </Card>

  <Card title="Sync data from MoEngage to Salesforce" icon="arrow-right-from-bracket" href="/partner-guide/data-and-analytics/crm/salesforce-crm-native/sync-data-from-moengage-to-salesforce">
