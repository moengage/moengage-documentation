...
- Follow the steps in [Set up MoEngage app on Salesforce](/partner-guide/data-and-analytics/crm/salesforce-crm-native/setup-moengage-app-on-salesforce) to set up the MoEngage Streams Connected App on Salesforce.
