...
- **Simple configuration**: Use [pre-built JSON payloads](/partner-guide/data-and-analytics/crm/zoho-crm#mapping-references) with MoEngage's default field mappings.
- **Advanced configuration**: Use a [boilerplate template](/partner-guide/data-and-analytics/crm/zoho-crm#boilerplate-templates) to build your custom payload. To populate the key-value pairs with your specific data, use [Zoho CRM merge fields](https://help.zoho.com/portal/en/kb/crm/automate-business-processes/actions/articles/webhooks-workflow#Recognize_Unsupported_Merge_Field_Values).
