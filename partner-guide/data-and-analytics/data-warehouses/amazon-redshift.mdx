...
description: "Export MoEngage campaign interaction events to your Amazon Redshift cluster by granting access and connecting Redshift on the App Marketplace."
---
...
<Info>
  ...
  - Exporting data from MoEngage to Amazon Redshift uses MoEngage Streams, which is a paid add-on. To check what's available for your plan, refer to [Plans and Pricing](https://www.moengage.com/plans-and-pricing/). To enable it for your account, contact your MoEngage Customer Success Manager (CSM) or the Support team.
</Info>
