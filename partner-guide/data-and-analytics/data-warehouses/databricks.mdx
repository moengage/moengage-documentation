...
<Info>
  Exporting data from MoEngage to Databricks uses MoEngage Streams, which is a paid add-on. To check what's available for your plan, refer to [Plans and Pricing](https://www.moengage.com/plans-and-pricing/). To enable it for your account, contact your MoEngage Customer Success Manager (CSM) or the Support team.
</Info>
...
<AccordionGroup>
  <Accordion title="Method 1: Service Principal with OAuth (Recommended)">
    ...
    **Generate an OAuth secret for the service principal**
    ...
    <Frame>
      ![Generated client\_id and client\_secret confirmation screen](/images/Auth3.png)
    </Frame>
  ...
  <Accordion title="Method 2: Personal Access Token (PAT)">
    ...
    **Generate the Token**
    ...
    - **User token via the user interface:**
      ...
      5. Click **Done**. <img src="/images/partner_35794647020308.png" alt="Screenshot 2025-02-25 at 6.03.21 PM.png" />
...
<Tabs>
  ...
  <Tab title="Exports">
    ...
    **Bare Minimum Grants (MoEngage Creates the Table)**
    ...
    ```sql Export SQL Permissions wrap
...
Databricks is available in our Warehouse Segments. For more information, refer to [Warehouse Segments](https://www.moengage.com/docs/user-guide/segment/create-segments/warehouse-segments).
