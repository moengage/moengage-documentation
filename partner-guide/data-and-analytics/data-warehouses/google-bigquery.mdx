...
description: "Connect Google BigQuery to MoEngage to sync warehouse audiences, import users and events, and export campaign interaction events."
---

<Info>
  Exporting data from MoEngage to BigQuery uses MoEngage Streams, which is a paid add-on. To check what's available for your plan, refer to [Plans and Pricing](https://www.moengage.com/plans-and-pricing/). To enable it for your account, contact your MoEngage Customer Success Manager (CSM) or the Support team.
</Info>
...
BigQuery is available in our Warehouse Segments. For more information, refer to [Warehouse Segments](https://www.moengage.com/docs/user-guide/segment/create-segments/warehouse-segments).
