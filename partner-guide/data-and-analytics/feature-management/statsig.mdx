...
1. [Generate Authentication Credentials and Request the Integration Endpoint](/partner-guide/data-and-analytics/feature-management/statsig#step-1-generate-authentication-credentials-and-request-the-integration-endpoint)
2. [Configure the Event Webhook in Statsig](/partner-guide/data-and-analytics/feature-management/statsig#step-2-configure-the-event-webhook-in-statsig)
3. [Verify Events in MoEngage](/partner-guide/data-and-analytics/feature-management/statsig#step-3-verify-events-in-moengage)
...
4. In the URL box, paste the MoEngage endpoint URL that MoEngage Support provisioned in [Step 1](/partner-guide/data-and-analytics/feature-management/statsig#step-1-generate-authentication-credentials-and-request-the-integration-endpoint).
5. Click **Enable**.
