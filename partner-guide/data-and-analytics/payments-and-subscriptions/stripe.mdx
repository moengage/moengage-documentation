...
6. On the **Configure your destination** step, in the **Endpoint URL** box, paste the MoEngage endpoint URL you built in the [Generate Authentication Credentials](/partner-guide/data-and-analytics/payments-and-subscriptions/stripe#step-1-generate-authentication-credentials) section, and then enter a descriptive name in the **Destination name** box.
