...
You can now use these content APIs in your campaigns. [Read here](/user-guide/campaigns-and-channels/getting-started/campaign-content/content-apis) to know more about Content APIs.
