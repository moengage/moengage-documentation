...
5. Fill in the form: <img src="/images/partner_15040737347220.png" alt="Amplitude Event Streaming integration setup form for MoEngage" />
   ...
   3. Enter **DATA APP ID**.
6. Enter **Data Center Values**: "01", "02", "03", "04". Refer to [the article here](https://www.moengage.com/docs/user-guide/data/key-concepts/data-centers-in-moengage) for more details.
   | Field | Description |
   | --- | --- |
...
7. Toggle the **Send events** and filters to select the events to send.
   <Note>
