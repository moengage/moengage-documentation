...
![Latest moengage-segment-integration version on Maven Central](https://maven-badges.sml.io/maven-central/com.moengage/moengage-segment-integration/badge.svg)
...
To opt out of MoEngage's token registration mechanism disable token registration using [_configureFCM()_](https://moengage.github.io/android-api-reference/core/com.moengage.core/-mo-engage/-builder/configure-fcm.html) API while configuring FCM in the \_[MoEngage.Builder](https://moengage.github.io/android-api-reference/core/com.moengage.core/-mo-engage/-builder/index.html) \_as described
...
We recommend you to add the callbacks in the **_onCreate()_** of the Application class since these callbacks can be triggered even when the application is in the background.
