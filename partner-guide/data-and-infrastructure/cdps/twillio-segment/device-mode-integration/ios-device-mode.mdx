...
<Warning>
  This SDK built on top of [analytics-ios](https://github.com/segmentio/analytics-ios) will no longer receive updates. We recommend you use the [MoEngage-Segment-Swift](https://github.com/moengage/MoEngage-Segment-Swift) SDK built on top of [analytics-swift](https://github.com/segmentio/analytics-swift). Refer to the [MoEngage-Segment-Swift documentation](/partner-guide/data-and-infrastructure/cdps/twillio-segment/device-mode-integration/ios-swift-device-mode) for more details.
</Warning>
...
**Segment-MoEngage** is supported through SPM from SDK version 7.1.0. To integrate use the following GitHub URL link and set the branch as master or version as 7.1.0 and above [https://github.com/moengage/MoEngage-Segment-iOS.git](https://github.com/moengage/MoEngage-Segment-iOS.git)
...
<Warning>
  Please make sure to set the Data Center/ Region for MoEngage SDK separately in your AppDelegate's `application:didFinishLaunchingWithOptions` method. Refer [doc](https://www.moengage.com/docs/developer-guide/ios-sdk/sdk-integration/basic/data-center) for more info.
</Warning>

<Warning>
  Don't miss to add **\[config use:\[SEGMoEngageIntegrationFactory instance\]\]** while setting up Twilio Segment SDK. **Unless this is done data will not be sent to MoEngage**.
</Warning>
...
![64351a3-Screen\_Shot\_2018-09-20\_at\_11.25.31.png](/images/partner_27034995134868.png)
...
For more info on this refer the following [link](https://www.moengage.com/docs/developer-guide/ios-sdk/data-tracking/basic/install-update-differentiation).
