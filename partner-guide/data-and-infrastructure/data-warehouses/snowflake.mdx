...
4. Provide your Snowflake data warehouse details: <img src="/images/partner_23948983262100.png" alt="Snowflake connection form" />
   ...
   MoEngage also supports the rotation of keys. If your IT Policy requires key rotation, you can do it by following these steps:
   1. Go to the **App Marketplace** \> **Snowflake** \> **Integrate** and edit the connection.
   2. Click on the generate new key icon: <img src="/images/partner_23949032074388.png" alt="Generate new key icon" />
