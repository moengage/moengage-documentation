...
6. On the **Configure your destination** step, paste the MoEngage endpoint URL you built in Step 1 into the **Endpoint URL** field, and then enter a descriptive **Destination name**.
...
1. In the MoEngage dashboard, on the left navigation menu, go to **Segment** \> **Search Users**.
