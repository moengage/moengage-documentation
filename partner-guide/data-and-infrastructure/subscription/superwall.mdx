...
![Superwall Edit Webhook page showing the MoEngage webhook URL and selected subscription events](/images/superwall-webhook-config.png)
...
![initial_purchase event in the MoEngage user event activity view](/images/superwall-moengage-verify.png)
