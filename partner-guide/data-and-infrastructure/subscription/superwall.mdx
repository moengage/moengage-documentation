...
To authenticate requests from Superwall to MoEngage, you need your Workspace ID and Data API Key.

1. On the MoEngage dashboard, go to **Settings** \> **Account** \> **APIs**.
2. Copy the following details:
   - **Username**: Your Workspace ID (formerly App ID).
   - **Password**: The Data API Key found under the **Data** tile.
3. Build your webhook URL by inserting your Workspace ID and Data API Key into the MoEngage endpoint. Use the following format:
...
2. In MoEngage, go to **Segments** \> **Search Users**.
