...
| --- | --- | --- |
| Push | [Send Push Notification](/api/push/push-api) | Push API helps to: <ol><li>Create campaigns (targeting all users or a group of users) to send notifications.</li><li>Target a single user using a unique user attribute.</li><li>Personalize the payload for each user.</li></ol> |
