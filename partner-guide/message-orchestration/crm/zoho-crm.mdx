...
10. Click **Next**. <img src="/images/partner_40830764972948.png" alt="Image of Next button" /> \
    In the **CONDITION** block, you can define the workflow rule to execute for all records or add specific filter conditions if needed.

    ![Image of CONDITION block](/images/account-push.png)
