...
Use [MoEngage content APIs](/user-guide/campaigns-and-channels/getting-started/campaign-content/content-apis#using-content-apis-in-moengage) to add EduMe as one of your endpoints.
