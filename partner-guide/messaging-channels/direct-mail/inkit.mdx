...
On the Inkit platform, create a template to be used in your MoEngage campaign. Select the [Inkit API as documented here](https://docs.inkit.com/docs/using-the-api) which you want to use - Send out Postcards or Letters
