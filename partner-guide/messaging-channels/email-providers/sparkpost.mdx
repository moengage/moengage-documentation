...
- Access Signals Analytics via the UI
...
![1.png](/images/partner_26835292621972.png)

For documentation on how to skip API key generation upon initial subaccount creation by using the "setup\_api\_key" boolean string, please click here.

**Note**: Subaccounts cannot be nested beneath other subaccounts.

This is how subaccount creation appears in the app:

![2.png](/images/partner_26835292630932.png)
...
Subaccount event data is provided via webhooks and the message events API. The subaccount\_id key/value pair indicates which subaccount the event is attributed. You can use this attribute to filter/manage raw events by subaccount outside of SparkPost. Please note, you can create a webhook to stream only raw event data for a specific subaccount.
...
![3.png](/images/partner_26835292651284.png)
...
![4.png](/images/partner_26835284436884.png)
...
Full documentation for creating, listing, and editing subaccounts can be found in our API documentation here. The documentation for the supported API calls listed above also includes additional options for subaccounts.