...
description: "Sync Adobe Experience Manager Experience Fragments to MoEngage as Content Blocks using a custom AEM workflow process step."
---
...
2. On the APIs page, copy the following credentials:
   ...
   2. **Campaign API Secret**: You can use this as Basic Authentication. <img src="/images/partner_44996805286548.png" />
