...
![Ticketek Content API configuration in the MoEngage dashboard](/images/Tickete1.png)
...
![Ticketek Content API response fields referenced in a campaign template](/images/Ticketek2.png)
<Tip>
  **Tip**
