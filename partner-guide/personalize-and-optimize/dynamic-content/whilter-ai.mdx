...
6. Click **Save**. <img src="/images/partner_46651404053012.png" alt="Save Configuration Screenshot" />
   The setting status is shown as **Active**. For more information, refer to [Authorization Configuration with OAuth 2.0](/user-guide/settings/advanced-settings/authorization-configuration-with-oauth-20).
