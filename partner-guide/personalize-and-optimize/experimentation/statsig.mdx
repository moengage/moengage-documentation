...
| **Data API key** | The key you copied from the **Data** tile. MoEngage Support uses it to authenticate the endpoint that ingests your Statsig events. |
...
Statsig events appear in the event history. To confirm the events arrived correctly, check the following attributes:
