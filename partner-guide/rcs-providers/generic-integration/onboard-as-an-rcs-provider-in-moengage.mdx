...
| Key | Optional/Required | Data Type | Description |
|---|---|---|---|
| type | Required | String | This field denotes the type of templates. Supported values are: TEXT, CARD, MEDIA |
...
| Key | Optional/Required | Data Type | Description |
|---|---|---|---|
| media["media_url"] | Required | Object | This field denotes the type of templates. Supported values are: TEXT, CARD |
