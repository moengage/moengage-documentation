...
description: "Standard request payload and callback formats for vendors onboarding as a native RCS service provider in MoEngage."
---
...
| webview\_view\_mode | Optional | String | This field is required only if a webview is used within the application. |
