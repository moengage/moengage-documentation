...
description: "This article describes the standard payload formats that MoEngage uses for sending RCS template messages and standard callback formats for delivering callback information to MoEngage."
---
...
| rcs | Required | Object | This field denotes the object containing the RCS message and contains keys specific to RCS and the type of RCS message. For more information, refer to [rcs](/partner-guide/rcs-providers/generic-integration/onboard-as-an-rcs-provider-in-moengage#rcs). |
| sms | Optional | Object | This field denotes the details of the SMS message. For more information, refer to [sms](/partner-guide/rcs-providers/generic-integration/onboard-as-an-rcs-provider-in-moengage#sms).<br />**Note**: Only present if fallback as SMS is selected by the client. |
                   ...
                   "type": "CARD",
                    "data": {
                      "media": {
                        ...
                        "description": "John is happily welcomed to Moengage and will be a crucial part of the Product team",
                        "orientation": "HORIZONTAL",
                        "height": "",
                        "alignment": "LEFT",
                        "parameters": {
...
| **Key** | **Optional/Required** | **Data Type** | **Description** |
| --- | --- | --- | --- |
| type | Required | String | This field denotes the type of templates. Supported values are: <ul><li>TEXT</li><li>CARD</li><li>CAROUSEL</li><li>MEDIA</li></ul> |
...
```json
{
   ...
   "postback_data": "postback data string",
   "url": "url",
   "application": "WEBVIEW" | "BROWSER", //optional 
   "webview_view_mode": "FULL"| "HALF" | "TALL" //optional 
}
```
