...
2. In the search box, enter ChatGPT.
3. Under **Search results**, click the **ChatGPT Ads Conversions** tile.

   ![MoEngage App Marketplace with ChatGPT entered in the search box and the ChatGPT Ads Conversions tile in the results](/images/chatgpt-conversions-app-marketplace.png)
...
7. Click **Test** to validate and save the connection.
   ...
   ![Connection details form on the Integrate tab, showing the Connection name, API Key and Pixel ID fields with the Test button](/images/chatgpt-conversions-connection.png)
...
4. Click the delivery type you need: **One Time**, **Periodic**, or **Event Triggered**.
   ...
   ![Connected Apps dialog box with ChatGPT searched and the One Time, Periodic and Event Triggered delivery types](/images/chatgpt-conversions-delivery-type.png)
...
7. Under **Conversion Goals**, enter the following:
   ...
   ![Select connector section and Conversion Goals fields, showing Track ChatGPT Ad Conversions selected with Event Type, Action Source and Event ID](/images/chatgpt-conversions-conversion-goals.png)
...
10. Under **Event Data**, in the **Conversion Event Data** block, enter a key in the **Key** box and its value in the adjacent box. Click **+ New KV Pair** to add each further pair.
    ...
    ![Attribution, Advanced Matching and Event Data sections, showing Source URL, IP Address, Browser Details, External ID, Country, City, Zip Code and the Conversion Event Data key-value block](/images/chatgpt-conversions-attribution-matching.png)
...
12. Click **Next**, configure **Step 3** (Schedule and Goals), and then publish the campaign.
    ...
    ![Test Campaign section with the identifier list, the value box and the Test button, beside the Previous and Next buttons](/images/chatgpt-conversions-test-campaign.png)
...
MoEngage supports direct mapping to OpenAI's standard event taxonomy. The event names and the columns below follow OpenAI's own definitions. For the full specification of each event and the data it accepts, refer to [Supported Events](https://developers.openai.com/ads/supported-events) in the OpenAI documentation.
