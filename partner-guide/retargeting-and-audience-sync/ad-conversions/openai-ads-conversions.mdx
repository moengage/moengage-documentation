...
keywords: ["OpenAI Ads", "conversions", "CAPI", "server-to-server", "attribution", "MoEngage integration"]
---
...
4. Click the delivery type you need: **One Time**, **Periodic**, or **Event Triggered**.
   ...
   ![Connected Apps dialog box with OpenAI Ads searched and the One Time, Periodic and Event Triggered delivery types](/images/openai-conversions-delivery-type.png)
