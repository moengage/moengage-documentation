...
3. In the **Connected Apps** dialog box, search for **OpenAI Ads Conversions**, and then click the tile.
4. Click the delivery type you need: **One Time**, **Periodic**, or **Event Triggered**.

   ![Connected Apps dialog box showing the One Time, Periodic and Event Triggered delivery types](/images/openai-conversions-delivery-type.png)
