...
MoEngage provides a single omnichannel connector, **Track ChatGPT Ad Conversions**, available through the **OpenAI Ads Conversions** app in the MoEngage App Marketplace. It sends conversion events captured across all your environments (website, mobile app, and physical store) directly into your OpenAI Ads Manager.
...
## Step 3: Create a OpenAI Ads Conversions Campaign

To create a OpenAI Ads Conversions campaign, perform the following steps:
