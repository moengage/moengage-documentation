---
title: "Intercom"
description: "Sync users, leads, and support events from Intercom to MoEngage using Workflows or Series webhooks to trigger contextual engagement campaigns."
---
...
7. Click **Next step** to proceed to the **Test response** tab to test the connection by providing sample values for your payload. <img src="/images/mceclip8.png" alt="Test response tab showing a successful connection between Intercom and MoEngage" /> **Note**: Ensure Intercom is successfully connected to MoEngage before you use the connector in a live workflow.
...
<PartnerRateLimit partner="Intercom" />
