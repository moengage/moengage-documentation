...
All flows for this integration use the Microsoft Dataverse connector. For a detailed overview of how this connector works, see the official [Microsoft Dataverse documentation](https://learn.microsoft.com/en-us/connectors/commondataserviceforapps/).
