...
3. In the **Test webhook** section, provide the following details:
   ...
   4. Click **Send test**. <img src="/images/partner_42220212650260.png" />
...
To maintain platform stability, MoEngage limits ingestion of Zendesk data to a maximum of 500 requests per second (RPS) per workspace. If your workspace exceeds this limit, MoEngage returns an HTTP `429 (Too Many Requests)` status code.

Refer to Zendesk's default retry policy to understand how rate limiting affects your data flow.
