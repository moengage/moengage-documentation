...
- E-Commerce: [Try Out Products at a Nearby Store](/use-cases/push/drive-users-to-try-out-products-at-store), [Retarget Dropped Off Customers](/use-cases/flows/how-to-retarget-dropped-off-customers), [Personalized Recommendations using Product Grids](/use-cases/personalize/recommend-personalized-products-using-product-grids)
- OTT: [New Episode Alert](/use-cases/business-events/send-notifications-for-a-new-episode), [Continue Watching Content](/use-cases/recommendations/how-to-nudge-users-to-continue-watching-content), [Recommended Content to Watch Next](/use-cases/recommendations/recommend-content-to-watch-next)
- BFSI: [Card Payment Reminder](/use-cases/push/send-a-card-payment-reminder), [Cross-Sell Bill Payments](/use-cases/flows/how-to-cross-sell-bill-payments), [Reduce eKYC Abandonment](/use-cases/flows/how-to-reduce-ekyc-abandonment)
- Travel: [Send Flight Status Updates](/use-cases/push/send-flight-status-updates), [Extend Your Stay](/use-cases/flows/how-to-nudge-your-guests-to-extend-their-stay), [Message Users When They Enter a New Location](/use-cases/push/message-users-when-they-enter-a-location)