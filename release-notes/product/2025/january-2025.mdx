...
MoEngage now supports exporting encrypted files and has added support for PGP Encryption. For more information, refer to [Enable S3 Exports on the MoEngage App Marketplace](/user-guide/data/exports/events/data-warehouse/s3-exports#step-2-add-an-export-on-the-app-marketplace).