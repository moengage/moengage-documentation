...
<div style={{ padding: '16px', border: '1px solid #E8E8E8', borderRadius: '8px', marginBottom: '20px' }}>
  ...
  <ul style={{ listStyle: 'none', paddingLeft: '0' }}>
    ...
    <li><span style={{ color: '#8c8c8c', textDecoration: 'line-through', fontWeight: 'bold' }}>■ Deprecated:</span> Module is deprecated and will be removed in a future release. For more information, see the <a href="/developer-guide/android-sdk/deprecated-versions/deprecated-versions">Android SDK Deprecated Versions</a>.</li>
  </ul>
</div>
