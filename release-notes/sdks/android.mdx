...
<CardGroup cols={2}>
  <Card title="Modules">
    ...
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>moe-android-sdk x.x.x</span>
    ...
    push-amp 6.5.1 · realtime-trigger 4.5.1 · cards-core 3.5.1 · cards-ui 3.5.1 · geofence 5.4.0 · inbox 4.5.0 · pushkit 6.5.0 · inbox-ui 4.5.0 · security 4.4.0 · encryptedStorage 3.4.0
  </Card>
