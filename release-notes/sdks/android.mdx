...
**Catalog:** [X.X.X](https://github.com/moengage/android-dependency-catalog/releases/tag/catalog-vX.X.X) &nbsp;·&nbsp; **BOM:** [X.X.X](https://github.com/moengage/android-dependency-catalog/releases/tag/bom-vX.X.X)

<CardGroup cols={2}>
  <Card title="Modules">

    - <span style={{ color: '#008767', fontWeight: 'bold' }}>moe-android-sdk X.XX.XX</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>inapp X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>richNotification X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>push-amp X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>realtime-trigger X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>cards-core X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>cards-ui X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>geofence X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>pushkit X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>inbox X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>inbox-ui X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>personalization X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>security X.X.X</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>encryptedStorage X.X.X</span>
  </Card>
...
* **Return Result for public APIs:** Public APIs now return a `Result` object, giving you clear visibility into the success or failure of each operation.
...
* **Push to InApp:** Introduced support for triggering and displaying an in-app message upon push notification click.
...
* **Self-Handled Background Push**: Added support for the Self-Handled Background Push template. Refer to the [doc](/developer-guide/android-sdk/push/advanced/push-display-handled-by-application#background-update-template-manual-approach) for more information.
...
* **Custom Proxy Domain**: Introduced support for Custom Proxy Domains to route SDK traffic through a customer-owned subdomain for bypassing ad blockers and private DNS services. For more information, refer [here](/developer-guide/android-sdk/sdk-integration/advanced-or-optional/custom-proxy-domain-android).
...
**Catalog:** [3.2.3](https://github.com/moengage/android-dependency-catalog/blob/master/CHANGELOG.md#14-12-2023)
...
**Catalog:** [3.2.1](https://github.com/moengage/android-dependency-catalog/blob/master/CHANGELOG.md#15-11-2023)
