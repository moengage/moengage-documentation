...
<CardGroup cols={2}>
  <Card title="Modules">
    ...
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>moe-android-sdk 14.09.03</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>inapp 10.2.2</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>richNotification 6.6.1</span>
    - <span style={{ color: '#008767', fontWeight: 'bold' }}>personalization 1.0.2</span>
