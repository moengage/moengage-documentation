...
<Update label="13th August 2026" description="Core 10.8.1 · Cards 6.5.2 · Inbox 9.5.2 · Geofence 6.5.2 · Personalize 1.0.2">
<CardGroup cols={2}>
<Card title="Plugins">

**Core** <span style={{ color: '#00C896', fontWeight: 'bold' }}>10.8.1</span>

**Cards** <span style={{ color: '#00C896', fontWeight: 'bold' }}>6.5.2</span>

**Inbox** <span style={{ color: '#00C896', fontWeight: 'bold' }}>9.5.2</span>

**Geofence** <span style={{ color: '#00C896', fontWeight: 'bold' }}>6.5.2</span>
...
#### Core 10.8.1
<span style={{ background: 'rgba(9,109,217,0.1)', color: '#096DD9', border: '1px solid #91D5FF', borderRadius: '4px', padding: '2px 8px', fontSize: '12px', fontWeight: '600' }}>Improvements</span>
