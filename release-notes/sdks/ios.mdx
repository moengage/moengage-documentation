...
<Info>
  For information on supported versions and upgrade timelines, see the [SDK Version Lifecycle Policy](/developer-guide/components-for-sdk/platform-updates/sdk-version-lifecycle-policy).
</Info>
