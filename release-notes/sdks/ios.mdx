...
For a step-by-step upgrade path, the callback usage, the full API-to-task mapping, and the failure reason codes, refer to [Migration to SDK version 11.0.0](/developer-guide/ios-sdk/migration/migration-to-sdk-version-11-0-0).
