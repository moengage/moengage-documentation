...
<Update label="12th August 2026" description="Core 6.0.1 · Geofence 3.0.1 · Cards 3.0.1 · RichPush 3.0.1 · InApps 3.0.1">
...
<CardGroup cols={2}>
  <Card title="Packages">
    ...
    - <span style={{ color: '#00C896', fontWeight: 'bold' }}>Cards 3.0.1</span>
    - <span style={{ color: '#00C896', fontWeight: 'bold' }}>RichPush 3.0.1</span>
    - <span style={{ color: '#00C896', fontWeight: 'bold' }}>InApps 3.0.1</span>
  </Card>

  <Card title="Platform Support">
    **Android**
    - Native Android dependency: 14.09.01
  </Card>
</CardGroup>
