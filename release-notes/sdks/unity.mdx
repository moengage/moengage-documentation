...
<Update label="12th August 2026" description="Core 6.0.1 · Geofence 3.0.1">

### Release Summary

<CardGroup cols={2}>
  <Card title="Packages">
    - <span style={{ color: '#00C896', fontWeight: 'bold' }}>Core 6.0.1</span>
    - <span style={{ color: '#00C896', fontWeight: 'bold' }}>Geofence 3.0.1</span>
  </Card>

  <Card title="Platform Support">
    **Android**
    - Native Android dependency: 14.10.01
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Platform Support">
    **Android**
    - Native Android dependency updated from 12.10.02 to 14.10.00
...
<Warning>
  **Breaking Changes**
  ...
  - **`MoEngageConfiguration.h` is removed on iOS.** Migrate to `MoEngage-Info.plist` for SDK configuration. Refer to [iOS SDK Initialization](/developer-guide/unity-sdk/sdk-integration/sdk-initialization/file-based-initialization/ios) for details.
</Warning>
...
* **Android**: Native Android dependency updated from **12.10.02** to **14.10.00**.
...
* **iOS**: MoEngage-iOS-SDK dependency updated to **9.17.0** and above. Refer to the [iOS SDK release notes](/release-notes/sdks/ios) for details.
