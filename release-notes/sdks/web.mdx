...
<Update label="7th September 2026" description="v2.80.00">
...
- Analytics: Fixed `previous_identities` in the `update_unique_user_id` or `updateUniqueUserId` method.
</Update>

<Update label="13th August 2026" description="v2.79.02">
- Analytics: Scoped the `USER_ATTRIBUTE_UNIQUE_ID` `trackEvent` restriction to user-attribute events.
</Update>

<Update label="6th August 2026" description="v2.79.01">
- Analytics: Removed incorrect `USER_ATTRIBUTE_UNIQUE_ID` reports from batch payloads.
</Update>

<Update label="4th August 2026" description="v2.79.00">
- NPM: Stringified initialization input fields as part of VAPT remediation.
...
- SDK: Fixed anonymous user profile creation for subscriber-based dashboards.
