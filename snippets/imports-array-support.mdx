...
- **Array typecasting**: If an array `["1" | 2 | "abc"]` is mapped as Array Integer, MoEngage ingests `[1, 2]`, because `"abc"` cannot be cast to an integer and is dropped. For more information, see [typecasting in MoEngage](/user-guide/settings/data-management/overview-data-management).
