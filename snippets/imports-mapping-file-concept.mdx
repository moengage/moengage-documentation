...
### Standard User Properties for Reference

Map your source columns to MoEngage standard user properties using the keys below. For the exhaustive list, refer to your [Data Management](/user-guide/settings/data-management/overview-data-management) dashboard.
...
### Reserved Keywords for User Properties
