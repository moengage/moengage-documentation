...
For more information, refer to [Small Notification Icon Guidelines](https://developers.moengage.com/hc/en-us/articles/360061216011-Push-Configuration#01GRNPZWD99YXM7KBVC0458YFM) and [Android Notification Guidelines](https://m2.material.io/design/platform-guidance/android-notifications.html#anatomy-of-a-notification).
...
- The notification large icon is not in the initialization of the SDK. Please look at the [Push Configuration](https://developers.moengage.com/hc/en-us/articles/360061216011) documentation to check how to set the large icon.
