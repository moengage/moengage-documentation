...
Refer to the [Configuring HMS Push Kit](/developer-guide/android-sdk/push/optional/push-amp-plus/configuring-hms-push-kit) documentation to know more about how to set the listener.
...
Refer to the [InApp](/developer-guide/android-sdk/in-app-messages/in-app-nativ) documentation to know more on how to set the listener.
