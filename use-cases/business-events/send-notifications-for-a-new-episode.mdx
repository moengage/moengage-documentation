...
We will name the event as _ENT\_New\_Content\_Released_. We will have [example@moengage.com](mailto:example@moengage.com) as the email address that created this event. We will add the following event properties to the business event with their data types.
