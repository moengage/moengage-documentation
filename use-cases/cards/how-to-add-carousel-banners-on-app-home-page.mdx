...
2. [Cards UI Creation for each Category](/use-cases/cards/how-to-add-carousel-banners-on-app-home-page#step-2-guide-for-cards-ui-creation)
3. [Parsing MoEngage Cards Payload and Feed into the Carousel UI](/use-cases/cards/how-to-add-carousel-banners-on-app-home-page#step-3-parsing-moengage-cards-payload-and-feed-into-the-carousel-ui)
4. [Track Analytics](/use-cases/cards/how-to-add-carousel-banners-on-app-home-page#step-4-track-analytics)
...
To set card categories, [raise a support ticket](/user-guide/contact-support/raise-a-support-ticket-through-moengage-dashboard).
