...
Retail spans physical stores, apps, web, and marketplaces. Computed traits unify signals from all of them into live user properties you can segment on, personalize with, and branch Flows on, without engineering support or CSV uploads.
