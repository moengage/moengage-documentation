...
1. [Create a Calendar Invite](/use-cases/email/add-calendar-invites-to-emails#step-1-create-a-calendar-invite)
2. [Add a Calendar Invite to the Email Campaign](/use-cases/email/add-calendar-invites-to-emails#step-2-add-a-calendar-invite-to-the-email-campaign)
...
<Tabs>
  <Tab title="Add calendar link">
    ...
    7. Publish the campaign. The user receives a [preview of the invite](/use-cases/email/add-calendar-invites-to-emails#expected-result) in their inbox.
  </Tab>
