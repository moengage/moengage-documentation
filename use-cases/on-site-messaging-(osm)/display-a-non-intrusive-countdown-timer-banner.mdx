...
We will achieve this use case by creating a non-intrusive banner at the top of the website that displays a countdown timer for a sale. We will use the [On-site Messaging (OSM)](/use-cases/on-site-messaging-\(osm\)/display-a-non-intrusive-countdown-timer-banner#create-an-osm-campaign) feature of MoEngage.
