...
7. Search for the event "Product Searched" and then select **Predominantly** with Category as Fitness and then click **Add**. To know more about users affinity segments and the filters, refer [here](/user-guide/segment/create-segments/affinity-segments).  **<img alt="image-20240120-183254.png" src="/images/moengage_d67c9d.png" />**
