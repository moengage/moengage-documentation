...
6. Click **Next** to move to the second step, "Content," where you can define the content that will go into your campaign. You can create audiences based on user properties to highlight favorite categories upfront or use In-session behavior to bring recently viewed categories to prominence.
