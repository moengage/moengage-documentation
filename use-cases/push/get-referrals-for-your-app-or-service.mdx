...
We will achieve the use case by [creating a Push campaign](/use-cases/push/get-referrals-for-your-app-or-service#create-a-push-campaign) to get referrals for your app or service.
...
2. Enter the required content for the campaign. We can enter a title, message, and summary manually, or generate them using Merlin AI. For more information, refer to [Generate Push Messages with Merlin AI](/user-guide/ai-and-intelligence/merlin-ai/merlin-ai-copywriter/generate-push-messages-with-merlin-ai).
