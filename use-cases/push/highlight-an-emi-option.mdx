...
1. [Create an RFM segment](/use-cases/push/highlight-an-emi-option#step-1-create-an-rfm-segment)
2. [Create a Push Campaign](/use-cases/push/highlight-an-emi-option#step-2-create-a-push-campaign)
...
7. In the **Target audience** section, select our saved custom segment, _RFM-segment_ that we created in the [Step 1: Create an RFM segment](/use-cases/push/highlight-an-emi-option#step-1-create-an-rfm-segment) by searching for the same. <img alt="RFMusecase7.png" src="/images/moengage_1d2cb0.png" />
