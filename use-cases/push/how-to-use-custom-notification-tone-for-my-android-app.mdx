...
description: "Learn how to configure a custom notification tone for your Android app using notification channels, and map it to the MoEngage dashboard for campaign delivery."
---
...
2. In the **Basic details** section, add the notification channel:
   1. Expand the **Notification channel** drop-down list and click ** Manage notification channel**. ![Notification Channel drop-down menu in the Android push composer](/images/usecaseimage.png)
   2. The Manage android notification channel pop-up window is displayed. ![Manage notification channel modal showing channel name, ID, and importance fields](/images/add-a-new-channel.gif)
