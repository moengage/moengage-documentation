...
1. [Create a business event](/use-cases/push/send-flight-status-updates#step-1-create-the-business-event)
2. [Create a Push campaign](/use-cases/push/send-flight-status-updates#step-2-create-a-push-campaign)
3. [Trigger the campaign by triggering the business event](/use-cases/push/send-flight-status-updates#step-3-trigger-the-campaign-by-triggering-the-business-event)
