...
2. At the top right corner, click **\+ Create recommendation**. This will take you to the first step, "Select recommendation model."
   ![image-20231126-104436.png](/images/moengage_b6f7e6.png)
3. Select the **Recommended items** model and click **Next**. It takes you to the second step "Create recommendation". Enter the following details:
   ...
   3. **Catalog**: Select the catalog on which the recommendation will be worked.
      ![48fe4806-4e89-4f8c-a740-19e198c82ffb.png](/images/moengage_a206f6.png)
...
2. Under **Outbound**, select **Email** \> **Event Triggered**.
   ![13.png](/images/moengage_ed88c4.png)
...
3. Enter the following details:
   ...
   - **User attribute with email address**: Select "Email (Standard)."
     ![5.png](/images/moengage_280b67.png)
...
2. You can add a text box highlighting the Order ID and Order Value for further personalization.
   ![0c6340b1-5745-4ffd-96d7-0b95e24045ba.png](/images/moengage_d5d0cf.png)
3. For adding personalization, you can go to rows and select product sets
   ![a01f43f3-be3a-4f25-9a5d-1beb6df6f580.png](/images/moengage_372049.png)
4. You can choose the layout in which the product needs to be shown. You can pick and choose from the options below:
   ![7d8f6888-16fb-45a8-90d9-eab5d45e0183.png](/images/moengage_55af73.png)
5. Once this is created, drag and drop the personalized product set anywhere in the Email campaign as below:
   ![14e9f756-3a4f-4a04-8e3a-40ce5bde3123.png](/images/moengage_b55ba5.png)
