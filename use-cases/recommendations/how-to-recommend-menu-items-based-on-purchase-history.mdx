...
3. While defining the message, select the product set generated through the recommendation [you defined](/use-cases/recommendations/how-to-nudge-users-to-continue-watching-content). Enter “@” and search for the name of the recommendation that you built, in the Push Personalization pop-up.  
