...
2. At the top right corner, click **\+ Create recommendation**. It takes you to the first step "Select recommendation model". <img src="/images/moengage_47e1ea.png" alt="2.png" />
...
4. Click **Next**. It takes you to the second step "Create recommendation". Enter the following details:
   ...
   - **Catalog**: Select the catalog that has all the list of products offered by you with all related information. <img src="/images/moengage_955c7d.png" alt="image-20240120-112909.png" />
5. Click **Create** to save the changes and run the model.\
   Please note that this will take 24 hours. You can find the status of the model on the Recommendations home page: <img src="/images/moengage_d67d04.png" alt="image-20240120-113731.png" /> The Recommendation engine shares the set of products a user might prefer to buy with the product in their cart based on the users' historical actions.
...
1. Navigate to the sidebar on the left and click **Personalize** **\>** **All Experiences** and click **\+ Experience**, or click **\+ Create new** \> **Experience** \> **Web**. <img src="/images/moengage_40ed9a.png" alt="UC-88.png" /> You are taken to the first step "Target users" of defining a personalized experience.
2. Enter the following details:
   - **Experience name**: A name for the personalisation you are building. For example, "Recommendations".
   - **Experience Tags**: Add tags here to later identify this among the other personalized experiences you will be having. <img src="/images/moengage_336977.png" alt="image-20240120-114533.png" />
3. Under **Target Audience**, click **\+ Add Audience**, select **All Users** (a segment we have created in the past) and then click **Select**. <img src="/images/moengage_0e1074.png" alt="image-20240120-114855.png" /> Or click **\+ New Audience** to define the target audience. <img alt="image-20240120-114653.png" src="/images/moengage_8c7e8c.png" />
...
3. Define the logic in the **URL** section. <img src="/images/moengage_a3ebc7.png" alt="UC-17 2.png" />
4. In the input box under **Personalize URL**, enter the URL on which we will do the setup and click **Validate SDK setup**. This will check if the SDK is installed on the pages. <img src="/images/moengage_38dbbe.png" alt="UC-17 1.png" />
...
6. Click **\+ Variation** to add multiple variations if required and define the same. <img src="/images/moengage_651283.png" alt="image-20240120-122604.png" />
...
9. After you select the element, the following buttons are displayed: <img src="/images/moengage_577490.png" alt="Screenshot 2024-01-20 at 6.04.04 PM (1).png" /> **Note:** This option is available for all variations except the default variation and lets you personalize the content for each variation.
...
16. In step 3 "Map Information, select [the recommendation that we have generated](/use-cases/recommendations/how-to-recommend-products-to-increase-the-average-cart-size#create-a-recommendation) as mentioned above. <img alt="image-20240120-125815.png" src="/images/moengage_b09f55.png" />
...
20. After completing all edits, click **Save & exit** at the top right. <img alt="image-20240120-130530.png" src="/images/moengage_e8d646.png" /> This will close this tab and take you back to the Experience definition page in the MoEngage dashboard. <img alt="image-20240120-130624.png" src="/images/moengage_535442.png" />
...
1. In the **Send experience** section, select **Active continuously** and define when to start and end this experience. <img src="/images/moengage_9fcc89.png" alt="image-20240120-130725.png" />
