...
4. From the **Event Property** drop-down list, select event property "Variation ID" as the unique item ID attribute.
...
2. Enter the required content for the campaign that will be defined alongside the personalized product name value. For example:
   ...
   - Message
   - Message summary
3. To define the personalization placeholder, select the product set that is generated through the recommendation [that you defined](/use-cases/recommendations/how-to-use-recommendations-to-announce-price-drop). Enter “@” and search for “AbandonedCart”, the name of the recommendation that you built, in the Push Personalization pop-up. <img src="/images/moengage_dba897.png" />
