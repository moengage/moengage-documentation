...
5. To define the dynamic check mentioned above:
   ...
   4. Select the operator as "is" because we want an exact match and then change **Constant value** to **Event property**.
...
2. Enter the required content for the campaign. We can enter the content manually or generate it using Merlin AI. For more information, refer to [Generate Push Messages with Merlin AI](/user-guide/ai-and-intelligence/merlin-ai/merlin-ai-copywriter/generate-push-messages-with-merlin-ai).
3. While defining the message, select the product set that is generated through the recommendation [that you defined](/use-cases/recommendations/how-to-use-recommendations-to-announce-price-drop#create-a-recommendation). Enter “@” and search for “ProductViewed\_By\_Users”, the name of the recommendation that you built, in the Push Personalization pop-up. <img alt="image-20231126-112839.png" src="/images/moengage_d14127.png" />
