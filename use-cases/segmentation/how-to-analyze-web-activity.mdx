...
3. To see the recent events for web users, add an event attribute - "Platform" is "WEB", as shown below. <img alt="Filter view showing an event attribute filter for Platform is WEB in Recent Events." src="/images/analyse.png" />