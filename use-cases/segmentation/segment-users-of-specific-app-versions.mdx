...
1. On the left navigation menu in the MoEngage dashboard, click **Segments \> Create segment.** For more information on creating segments, refer [here](/user-guide/segment/segment-operations/rule-based-filter-segments).
