...
<Info>
  You cannot send push notifications to users who uninstalled your application. The best way to reach them is via Email campaigns. To run an Email campaign, you must configure your user properties with the email addresses of those uninstalled users.
</Info>