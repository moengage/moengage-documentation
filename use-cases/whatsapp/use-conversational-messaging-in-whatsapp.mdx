...
- [Create a WhatsApp campaign](#step-1-create-a-whatsapp-campaign)
- [Configure a Flow for the WhatsApp campaign created](#step-2-create-a-flow)
...
3. Personalize the message body with customer attributes or event properties such as the name and location of the user who you are nudging to select an insurance plan.\
...
6. Click **\+ Attribute** and select the campaign ID generated when you published the [WhatsApp campaign](#step-1-create-a-whatsapp-campaign) created in the previous section.
