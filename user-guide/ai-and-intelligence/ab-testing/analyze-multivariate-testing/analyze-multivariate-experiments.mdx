...
Use the **View** toggle on the **Variation Performance** panel to switch between the table and the graph.

![Variation Performance panel for an on-site message in table view, showing Variation 4 as the best variant, the uplift in the primary conversion goal, and each variation's active targets, impressions, clicks, conversions, revenue and chance to beat all other variations](/images/osm-variation-performance-table.png)

You can also view a graphical comparison:

![Variation Performance panel for an on-site message in graph view, showing active targets, impressions, click-through rate, conversion rate and revenue as grouped bars for each variation, the control group and the global control group](/images/osm-variation-performance-graph.png)
