...
![Variation Performance panel for an on-site message in table view, comparing active targets, impressions, clicks and chance to beat all other variations across five variations and the global control group](/images/multivariate-variation-performance-table.png)

You can also view a graphical comparison:

![Variation Performance panel for an on-site message in graph view, showing active targets, impressions and click-through rate as grouped bars for each variation](/images/multivariate-variation-performance-graph.png)
