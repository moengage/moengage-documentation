...
![Variation Performance in table view, showing the best variant, the uplift, and each variation's metrics](/images/osm-variation-performance-table.png)

You can also view a graphical comparison:

![Variation Performance in graph view, comparing each variation's metrics as grouped bars](/images/osm-variation-performance-graph.png)
