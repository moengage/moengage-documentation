...
| SMS| One-time, Periodic, Event Triggered |
...
| Compare connector delivery performance | "Which SMS connector delivered the highest delivery rate for my campaigns in the last 30 days?" |
| Analyze SMS template performance| "Which of my SMS templates in past campaigns had the highest click-through rate, and what did they have in common?"|
| Identify high-performing keywords| "What keywords in my SMS content are driving the highest engagement rate?"|
| Optimize message length and format| "Is my SMS message length affecting delivery or click-through performance?"|
