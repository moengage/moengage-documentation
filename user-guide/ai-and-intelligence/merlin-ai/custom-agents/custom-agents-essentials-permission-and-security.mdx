...
- **Immutability:** Session transcripts cannot be deleted or altered by users, ensuring a permanent audit trail of all AI interactions within your workspace. For details on reviewing a transcript, refer to [Anatomy of a Session Transcript](/user-guide/ai-and-intelligence/merlin-ai/custom-agents/run-and-manage-agent-sessions#anatomy-of-a-session-transcript).
