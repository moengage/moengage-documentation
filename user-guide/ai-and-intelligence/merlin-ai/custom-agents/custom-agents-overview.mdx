...
Each Custom Agent is designed for a specific, single-purpose task. The scope of an agent's capabilities is strictly defined by the tools and permissions you assign to it during configuration. Depending on these assigned tools, agents can perform various automated actions. For more information, refer to [Available Tools](/user-guide/ai-and-intelligence/merlin-ai/moengage-mcp-server#available-tools). 
