...
Workspace memory has no viewer and no clear action: you cannot inspect, edit, or clear its contents from the dashboard or through an API. Keep anything you would not want another agent to reuse out of an agent's instructions and inputs.
