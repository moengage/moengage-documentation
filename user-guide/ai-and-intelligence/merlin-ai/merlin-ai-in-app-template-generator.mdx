...
### Use a Figma Design as a Reference

If your design team works in Figma (or another design tool such as Photoshop), you can use the exported design as a reference:

1. In Figma, select the frame containing your In-App design.
2. Export the frame as a PNG file.
3. In the Merlin AI chat, click the **Image** icon and upload the exported PNG.
