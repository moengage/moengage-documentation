...
For AI-assisted segment creation through an external assistant like Claude or ChatGPT instead of the MoEngage dashboard, see the [MoEngage MCP segmentation tools](/user-guide/ai-and-intelligence/merlin-ai/moengage-mcp-segmentation-tools).
