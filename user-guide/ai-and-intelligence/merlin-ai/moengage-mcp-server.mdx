...
<Info>All analytics tools enforce a maximum date range of **30 days**.</Info>
...
<Tabs>
  <Tab title="MCP Server URL">
    ...
    ```
    <Info>For the MoEngage **docs** MCP, use `https://www.moengage.com/docs/mcp`</Info>
  </Tab>
  <Tab title="Connect with Claude">
    ...
    8. Configure **Tool permissions** (*Automatic*, *Ask first*, or *Disabled*) per tool.
  </Tab>
