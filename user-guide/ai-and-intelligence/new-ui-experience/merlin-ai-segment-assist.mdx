...
- Click **Open in filter** **view** to edit queries using filters manually. This result will be listed under the **Filters** tab in the **Query Results** section. For more information on creating segments manually, click [here](/user-guide/segment/segment-operations/rule-based-filter-segments).
