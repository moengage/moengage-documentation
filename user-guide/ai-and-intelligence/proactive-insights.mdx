...
- **Manual efforts to mine segments:** Extracting target customer segments at present requires manual efforts. Understanding the creation of micro-segments requires configuring variables such as user and event properties, time duration, and so on. This could be time-consuming and overwhelming for some users.
