...
- [**Segment Based on RFM**](/user-guide/ai-and-intelligence/proactive-insights/proactive-insights#rfm-insights)**:** RFM (Recency, Frequency, and Monetary) Model provides auto-segmentation and bucket users into categories such as Loyal, Promising, At Risk, and so on based on user behavior.
- [Auto Segmentation](/user-guide/ai-and-intelligence/proactive-insights/proactive-insights#actions-on-insights): Merlin AI automatically generates user clusters or segments using proprietary AI. Specify any event and attribute used for generating these clusters.
