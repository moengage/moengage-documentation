...
- Table for all the latest user properties (This table gets updated every day) - users\_base\_table
...
- Table for all the latest user properties (This table gets updated everyday) - users\_base\_table
...
- Table for all the latest user properties (This table gets updated everyday) - user\_base\_table
- MoEngage defined ID for app/site users in usertabel - user\_id
