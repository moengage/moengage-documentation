...
- `users_base_table` - This table has all the latest user properties. This table gets updated every day.
...
User properties to be used for push reachability -
...
User properties to be used for email reachability -
...
User properties to be used for SMS reachability -
