...
- **Aggregation distribution**: This option lets you distribute users into buckets of aggregated event properties. For example, you can get the distribution of users based on the minutes of songs played.  
...
- **What it does:** Groups users into defined buckets based on an aggregated numerical event property (for example, total minutes played, total purchase value). You can use predefined or custom ranges.
- **When to use it:**
