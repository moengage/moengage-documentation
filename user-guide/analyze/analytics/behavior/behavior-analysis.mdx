...
With **Split by**, you can compare the data using a specific attribute. To compare, click **\+ Split By** and select the attribute from the list with which you wish to compare. You can add a maximum of 10 attributes. For example, to obtain a chart for the number of songs played across different platforms. Select _product_viewed_ as the event and select _Platform_ in the **Split By** list.
