...
description: "Export filtered user properties like email IDs and phone numbers from MoEngage segments to run re-engagement campaigns on external channels."
---
...
5. From the **User property** drop-down list, select the user properties you wish to extract.
6. Click **Export**.
