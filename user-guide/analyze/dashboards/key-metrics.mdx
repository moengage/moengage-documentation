...
The metrics on this dashboard describe your product as a whole. For campaign-level metrics and their formulas by channel, refer to [Campaign Metrics](/user-guide/analyze/dashboards/campaign-metrics).
