...
- Update the user property **moe\_unsubscribe** to true through Server-to-Server (S2S) API calls.
- In the MoEngage dashboard, use the File Import tool to upload a CSV file that sets the user property **moe\_unsubscribe** to true for the targeted end users.

#### WhatsApp

Perform one of the following steps:

- Update the user property **moe\_wa\_subscription** to false through S2S API calls.
- In the MoEngage dashboard, use the File Import tool to upload a CSV file that sets the user property **moe\_wa\_subscription** to false for the targeted end users.

#### SMS

Perform one of the following steps:

- Update the user property **moe\_sms\_subscription** to false through S2S API calls.
- In the MoEngage dashboard, use the File Import tool to upload a CSV file that sets the user property **moe\_sms\_subscription** to false for the targeted end users.
