...
**Personalization Failed** occurs when one or more of the event/user attributes used in the request are not found for the specific user. For more information, refer to [Common Personalization Errors and FAQs](/user-guide/campaigns-and-channels/getting-started/message-personalization/common-personalization-errors-and-faqs).

**Error Codes** are shown as and what are received when a request is made to the Connector URL. The count shows the total aggregated number. For more information about these errors and how to resolve them, refer to [Connector Error Reference](/user-guide/campaigns-and-channels/connectors/connector-error-reference).
