...
3. **Failed:** Number of users for whom the response from the request URL returned any status **other than 200** or the users for whom we fail to find any value against the user/event properties used in Connector request.
...
**Personalization Failed** occurs when one or more of event/user properties used in request are not found for the specific user. For more information, refer to [Common Personalization Errors and FAQs](/user-guide/campaigns-and-channels/getting-started/message-personalization/common-personalization-errors-and-faqs).
