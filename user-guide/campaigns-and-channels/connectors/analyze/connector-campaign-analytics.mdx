...
**Error Codes **are shown as and what are received when request is made to Connector URL. The count shows the total aggregated number. For more information about these errors and how to resolve them, refer to [Connector Error Reference](/user-guide/campaigns-and-channels/connectors/connector-error-reference).
