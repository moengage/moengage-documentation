...
For more information about OAuth-related errors and how to resolve them, refer to [Connector Error Reference](/user-guide/campaigns-and-channels/connectors/connector-error-reference#oauth-errors-and-resolution).
...
This also helps prevent duplicate sends if a campaign batch is automatically rerun. For more information, refer to [Connector Error Reference](/user-guide/campaigns-and-channels/connectors/connector-error-reference#batch-rerun-and-duplicate-prevention).
