...
<Warning>
The Custom HTML Editor has a few known rendering, personalization, and editor-specific limitations. Review the [Known Limitations](#known-limitations) section below before building complex templates.
</Warning>
...
This will load your template in the Drag and Drop editor. If you see an error, follow the guidelines in the [ZIP File Format](#zip-file-format) section.
