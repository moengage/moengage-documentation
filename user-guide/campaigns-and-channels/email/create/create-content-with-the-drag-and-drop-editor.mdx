...
Personalized links can be added using the More \>\> Links. This will open a pop-up window where the user can access   and select from a list of personalized attributes (User profile attributes and Event properties).
