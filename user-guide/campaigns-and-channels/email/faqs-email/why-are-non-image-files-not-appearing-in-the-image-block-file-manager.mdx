...
<Note>
  For a related case where the editor displays an explicit error instead of failing silently, see [Why Does Uploading .mp4 Files Fail?](/user-guide/campaigns-and-channels/email/faqs-email/why-does-uploading-mp4-files-fail)
</Note>
