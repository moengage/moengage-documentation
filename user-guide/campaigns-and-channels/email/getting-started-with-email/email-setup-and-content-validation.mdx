...
3. Create a custom segment and save it as **test\_email\_settings**. For more information, refer to [Custom Segments](/user-guide/segment/create-segments/manage-segments).
