...
|                                                                                         | Event Attributes               | **Error Label:** "Event" or "Event attribute" **Example 1:** `No event found for event name : MOE_WHATSAPP_DELIVERED in the last 15 days` **Example 2:** `admin.admininvalid is missing` |
