...
<Tabs>
  <Tab title="Push">
    ...
    8. Create the content for the push campaign and add the delivery schedule. You can personalize the message, title, and summary with the business event's attributes. For more information, see [Personalization](/user-guide/campaigns-and-channels/getting-started/message-personalization/overview#event-properties).
