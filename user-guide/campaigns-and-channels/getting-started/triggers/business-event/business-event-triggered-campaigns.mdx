...
<Tabs>
  ...
  <Tab title="Flows">
    ...
    <Note>
      Business event-triggered flows have different trigger limits than campaigns: a maximum of 3 triggers per hour and 10 triggers per day. Because these flows enter users in bulk and can process millions of users in a single run, users may take up to 60 minutes to enter the flow after the business event is triggered. Account for this when you plan time-sensitive communication. For all business event limits, see [Limits and Supported Attributes](/user-guide/campaigns-and-channels/getting-started/triggers/business-event/overview-business-events#limits-and-supported-attributes).
    </Note>
  </Tab>
</Tabs>
