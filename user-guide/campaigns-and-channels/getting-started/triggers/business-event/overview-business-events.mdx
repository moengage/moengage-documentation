...
- **Trigger rate limits**: Trigger limits depend on what the business event runs:
  - **Campaigns**: A maximum of 50 business event triggers per hour.
  - **Flows**: A maximum of 3 triggers per hour and 10 triggers per day.
