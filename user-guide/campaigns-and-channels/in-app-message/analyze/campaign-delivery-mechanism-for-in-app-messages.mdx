...
<Info>
  - **SDK version**: Android BOM 1.3.0 or later (In-App module 9.7.0), and iOS 10.10.0 or later.
...
For the full configuration, refer to [Frequency Capping](/user-guide/settings/channels/delivery-controls/frequency-capping). Support for In-App frequency capping requires Android BOM 1.4.0 or later (In-App module 9.8.0) and iOS 10.10.0 or later.
...
Some In-App features require a minimum MoEngage In-App SDK version. Users must be on an app build that includes that version for the feature to work on their device. For Android, the [BOM](/developer-guide/android-sdk/sdk-integration/basic-integration/Install-Using-BOM) (Bill of Materials) version is the recommended reference, with the In-App module version listed alongside it; a dash indicates the feature predates BOM-based versioning. iOS versions are the package version. Hybrid platforms (React Native, Flutter, Cordova, Capacitor) may have their own minimums.

| Feature | Android BOM | In-App module (Android) | iOS |
| --- | --- | --- | --- |
...
| On push click | 2.3.0 or later | 10.3.0 or later | 10.14.0 or later |
| Multiple triggers within an event (AND/OR conditions) | — | 8.1.0 or later | 9.16.1 or later |
| Nudges (`showNudge()`) | — | 7.0.0 or later | 9.16.1 or later |
| Re-evaluate campaign eligibility | 1.3.0 or later | 9.7.0 or later | 10.10.0 or later |
| Frequency capping | 1.4.0 or later | 9.8.0 or later | 10.10.0 or later |
