...
%%{init: {'theme':'base','themeVariables':{'fontFamily':'Inter, system-ui, -apple-system, sans-serif','fontSize':'13px','lineColor':'#94a3b8'}}}%%
flowchart TD
    ...
    style CONFIG fill:#f8fafc,stroke:#e2e8f0,color:#475569
    style FETCH fill:#f8fafc,stroke:#e2e8f0,color:#475569
    style TRIGGER fill:#f8fafc,stroke:#e2e8f0,color:#475569
    style SELECT fill:#f8fafc,stroke:#e2e8f0,color:#475569
    style DISPLAY fill:#f8fafc,stroke:#e2e8f0,color:#475569

    classDef process fill:#ffffff,stroke:#cbd5e1,stroke-width:1px,color:#334155;
    classDef decision fill:#eef2ff,stroke:#a5b4fc,stroke-width:1px,color:#3730a3;
    classDef stop fill:#fff1f2,stroke:#fda4af,stroke-width:1px,color:#9f1239;
    classDef success fill:#ecfdf5,stroke:#6ee7b7,stroke-width:1px,color:#065f46;

    class A,A2,A3,A4,B1,B3,B4,B5,C1,D1,D2,E1 process;
    class B2,C2,D3,D4,E2 decision;
