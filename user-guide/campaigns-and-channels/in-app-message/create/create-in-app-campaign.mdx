...
2. From the left navigation, use one of the following options:
   - Click **Engage** \> **Campaigns**. The All Campaigns page displays. At the top right, click **\+ Create Campaign**. The Create Campaign page appears. <img src="/images/moengage_bcadd6.png" alt="1.png" />
   - Click **Create New** \> **Campaign**. The Campaign page appears. <img src="/images/moengage_030fbd.png" alt="2.png" />
3. Under **Inbound**, click **In-App**. The In-App campaign creation page appears. <img src="/images/moengage_65cf95.png" alt="2025-05-13_15-17-14.png" />
...
<Tabs>
  <Tab title="On session start">
    ...
    ![Screenshot 2025-03-03 at 4.07.40 PM.png](/images/moengage_6bae65.png)
  ...
  <Tab title="On screen load">
    ...
    ![Screenshot 2025-03-03 at 4.14.38 PM.png](/images/moengage_76ad4f.png)
    ...
    ![2025-03-03\_16-29-26 (1).gif](/images/moengage_55065c.png)
  ...
  <Tab title="On custom event">
    ...
    ![Screenshot 2025-03-03 at 4.35.26 PM.png](/images/moengage_b6a198.png)
    ...
    ![Screenshot 2025-03-03 at 4.43.28 PM.png](/images/moengage_b3dc7c.png)
    ...
    ![Screenshot 2025-03-03 at 4.51.54 PM.png](/images/moengage_9741bc.png)
  ...
  <Tab title="Push to In-app">
    Select **Push to In-app** to link this In-App campaign to a push campaign. The In-App message then displays on the target screen when a user clicks the connected push notification.

    This trigger addresses the limitations of triggering an In-App message from a separate journey after a user receives a push. With that approach, the message often appeared only in the user's next session, and delivery controls such as frequency capping or campaign priority could prevent it from displaying. The Push to In-app trigger displays the linked In-App message on top of the screen the push opens.

    ![The Push to In-app trigger card selected, with the Select Push Campaign and Select trigger time options below it.](/images/push-to-in-app-trigger.png)

    To configure this trigger:

    1. Under **Trigger criteria**, select **Push to In-app**.
    ...
    ![The Select Push Campaign drop-down showing the Campaign name and Campaign ID filter options.](/images/push-to-in-app-select-campaign.png)
    ...
    **What the user experiences:**
    ...
    <Info>
      **Supported push campaign types**
      ...
      {/* TODO: Confirm with PM that One Time "As soon as possible" push is unsupported (scope table says the user must schedule a time, but the marketer-flow section lists ASAP as an option). */}
      ...
      **Supported platforms**: Android and iOS. Web push is not supported.
      ...
      {/* TODO: Confirm minimum SDK versions for Push to In-app. The dashboard shows a feature-specific banner ("Support of Push to In-app is available only from In-app Android ... and iOS ...") but the version numbers are not yet confirmed. */}
      - Android SDK version {/* TODO: version */}
      - iOS SDK version {/* TODO: version */}
    </Info>
...
|  |  |
| --- | --- |
| In the **Control group** section: <br/>&bull; Turn the **Global control group** toggle on to not send the campaign to all users in the control group.<br/>&bull; Turn the **Campaign control group** toggle on to not send the particular campaign to the control group.<br/><br/>For more information, refer to [Control Group](/user-guide/campaigns-and-channels/getting-started/introduction/control-groups). | <img alt="control group.png" src="/images/moengage_4f8241.png" /> |
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Take users to the app <b>Settings</b> screen. This option is only available on iOS.</td>
            </tr>
            <tr>
      ...
      <td>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>Navigate to notification settings</td>
              <td>Take the user to the application notification settings screen where the user can manage notification permission. Android only.</td>
            </tr>
            <tr>
              <td>Navigate to Settings</td>
              <td>Take the user to the application settings screen where the user can manage notification permission. iOS Only.</td>
            </tr>
            <tr>
...
<Accordion title="Tracking Revenue Performance (Optional)">
  |  |  |
  | --- | --- |
  | With MoEngage, you can track the revenue generated by your campaigns. For example, track the revenue generated by your product after sending a communication. To track revenue performance, enable the **Revenue performance** toggle for the conversion goal for which you want to track the revenue.  In the example here, to track revenue for _orderSuccessful_ events, enable the **Revenue performance** toggle. | <img alt="TrackingRevenuePerformance.png" src="/images/moengage_4db5fe.png" /> |

  |  |  |
  | --- | --- |
  | After choosing the goal, select the numeric attribute that captures the order's total monetary value. In this example, _cartValue_ contains the total order value. You can choose the currency in which your monetary value is reported. | <img alt="RevenuePerformance.png" src="/images/moengage_9db6b5.png" /> |

  |  |  |
  | --- | --- |
  | **Set Attribution window**: Set an attribution window (a time period or window calculated from when the user receives/clicks the campaign, for which you want to attribute conversion goals to a specific campaign). By default, it is set for 36 hours, while the maximum attribution window can be set up to 10 days. In the example below, the attribution window is set to 5 hours. | <img alt="Attribution Window.png" src="/images/moengage_2ce3bf.png" /> |

  ### Campaign Priority

  Set a priority for your In-App campaign as **Critical**, **High**, **Medium**, **Normal**, or **Low**.

  Campaigns that use the **Push to In-app** trigger have an additional **Critical - Functional** priority. Critical - Functional ranks above all other priorities, including Critical, so the linked In-App message displays over all other campaigns. For Push to In-app campaigns, the priority is set to Critical - Functional automatically and cannot be changed.

  ![The Campaign priority selector with Critical - Functional selected for a Push to In-app campaign.](/images/push-to-in-app-campaign-priority.png)
  ...
  <Note>
    For **Push to In-app** campaigns, MoEngage configures the delivery controls automatically so the linked In-App message always displays when the user clicks the push. The maximum number of times to show, the minimum delay between messages, **Ignore frequency capping**, **Ignore global minimum delay**, and **Count for the frequency capping** are disabled and cannot be changed. Only **Auto dismiss message after** remains configurable.
  </Note>

  ![The Global Delivery controls for a Push to In-app campaign, with the toggles disabled.](/images/push-to-in-app-delivery-controls.png)
