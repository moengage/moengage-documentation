...
<Info>
  ...
  **Availability and Scope**
  ...
  - **Supported segments**: This feature is available only for User Property-based segments and Real-Time Segment Evaluation (RTSE) segments.
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                1. Select the user property from the drop-down list.<br/>
                2. Type or paste the value for the user property.
              </td>
            </tr>
            <tr>
...
Personalize the content of your In-App campaign by using the '@' symbol to insert user properties, user events, product sets, content APIs, and content blocks. This enables dynamic and relevant messages for each user.
