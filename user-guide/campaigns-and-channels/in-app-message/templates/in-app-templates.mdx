...
<Info>
  ...
  The **Floating** nudge placement, which lets users drag the nudge around the screen, requires a newer SDK version. {/* TODO: Confirm minimum InApp Android and iOS SDK versions for Floating nudge placement. */}
</Info>
