...
3. Fill in the following fields in the template editor to create your Nudge. As you make changes, a preview of the template displays.
   - **Template Settings**
     ...
     | --- | --- | --- |
     | **Placement and Background** | **Nudge Placement** | Choose how the nudge is positioned on the screen: <ul><li>**Fixed**: The nudge stays in a fixed position. Select **Bottom left** or **Bottom right**.</li><li>**Floating**: The user can drag the nudge to move it around the screen. Select **Bottom left** or **Bottom right** as the starting position.</li></ul>The **Floating** placement (Movable Nudges) is available from In-App Android SDK version 11.0.0 and In-App iOS SDK version 10.14.0. |
