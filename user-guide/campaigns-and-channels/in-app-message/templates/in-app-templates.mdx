...
<Info>
  ...
  **Movable Nudges** — repositioning a nudge on the screen using the **Floating** placement — is available from In-App Android SDK version 11.0.0 and In-App iOS SDK version 10.14.0.
</Info>
