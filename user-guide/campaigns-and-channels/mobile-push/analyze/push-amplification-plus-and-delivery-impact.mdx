...
Push Amplification™ Plus improves push delivery rates by up to 40%, but it has some limitations.

### SDK Compatibility

Push Amplification™ Plus is available from these SDK versions onward:

| Android SDK type | Support on Huawei |
| --- | --- |
...
### Direct Delivery Service Limitations

These apply to the direct delivery service, not the fallback service:
