...
<Tabs>
  ...
  <Tab title="Scheduling">
    ...
    - Delivery Controls - Information about frequency capping, throttling, message queuing, and minimum delay between campaigns.
      <Note>
        The [Message Queueing](/user-guide/settings/channels/delivery-controls/message-queuing) feature is an Early Access feature. To enable it for your account, contact your MoEngage Customer Success Manager (CSM) or the Support team.
      </Note>
