...
You can also copy the Coupon Personalization snippet from the coupon's detail page under **Content** > **Coupons**. For more information, refer to [Use a Coupon List in a Campaign](/user-guide/content/coupons/use-a-coupon-list-in-a-campaign).
