...
- For SDK integration guides and updates on Live Activity support, refer to the [MoEngage SDK Documentation](https://www.moengage.com/docs/developer-guide/ios-sdk/push/optional/broadcast-live-activity).
- For API guides, refer to the [Broadcast Live Activties API documents](https://www.moengage.com/docs/api/live-activities/live-activities-overview).
