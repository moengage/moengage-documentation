...
MoEngage SDK tracks the opt-in status of the user’s devices by default using the *Reachability Push iOS* user property. This attribute can have the following values:
