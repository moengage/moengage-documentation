...
keywords: ["notification actions", "action buttons", "call-to-action buttons", "notification tray buttons", "share action", "call action", "action click performance", "iOS 15 notification changes"]
---
...
| --- | --- | --- | --- |
| Android | Android 4.1 (API 16) and above | SDK Version 6.0.02 and above | [Check about our latest SDK](https://developers.moengage.com/hc/en-us/articles/360062022652-Android-SDK-Integration) |
| iOS\*\* | iOS 8 and above | SDK Version 2.2 and above | [Check about our latest SDK](/developer-guide/ios-sdk/sdk-integration/basic/sdk-integration) |
...
| Set attribute | To set any user property on basis of a user action | Attribute Key-Value |
...
**4) Track Event**(for Android only): To track an event generated on Click Action. The user should put the name with which he/she wants to track the event as well as its Attribute value.

<img alt="track_event.png"  src="/images/moengage_bc0e2d.png"  />

**5)** **Set Attribute**(for Android only): You can use this to set any user property on basis of user action. Just choose the existing attribute from the User Property dropdown or create a new one and configure the value that you want to set on the button click.

<img alt="SetUserAttribute.png"  src="/images/moengage_8eea80.png"  />

**6)** **Custom Action**(for Android only): Helps perform the app functions like Add to Cart or Play a song etc. directly from the notification. [Check here](/developer-guide/android-sdk/push/advanced/callbacks-and-customisation) on how to integrate them into your apps.
