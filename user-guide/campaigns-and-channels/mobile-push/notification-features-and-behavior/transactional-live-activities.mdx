...
Once you configure the Inform campaign, your backend development team can use the Inform API to trigger real-time updates. For more information, refer to the [Inform API](/api/transactional-alerts/send-transactional-alert).
...
- For API payload specifications, refer to the [Inform API Documentation](/api/transactional-alerts/send-transactional-alert).
