...
keywords: ["location triggered push", "geofence campaign", "geofence push", "location based notification", "geofence evaluation"]
---
...
3. Refer to the following sections in the [Location Triggered](/developer-guide/android-sdk/push/optional/location-triggered) documentation to create a location-triggered push campaign:
