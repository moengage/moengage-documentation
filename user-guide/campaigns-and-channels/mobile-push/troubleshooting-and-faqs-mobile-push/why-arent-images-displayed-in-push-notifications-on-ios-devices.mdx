...
description: "Fix images not showing in iOS push notifications by implementing the Notification Service Extension with the correct MoEngage SDK version and setup."
keywords: ["images not showing iOS push", "Notification Service Extension", "rich media not rendering", "image attachment iOS", "mutable-content"]
---
