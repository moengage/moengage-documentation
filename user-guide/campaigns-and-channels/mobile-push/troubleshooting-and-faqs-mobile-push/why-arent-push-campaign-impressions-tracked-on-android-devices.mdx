...
- When MoEngage SDK handles push notifications by default:
  - Confirm SDK initialization. Check if the SDK is initialized with a delay.
    - If the SDK is initialized with a delay, change the SDK initialization to the default configuration, as specified in the following MoEngage documentation links. Initialize the SDK in the **onCreate()** method of the Application class on the main thread, not in any callbacks.
      - [Android Native](/developer-guide/android-sdk/sdk-integration/basic-integration/sdk-initialization)
      - [React Native](/developer-guide/react-native-sdk/sdk-integration/react-native/sdk-initialization/manual-initialization/android)
      - [Flutter](/developer-guide/flutter-sdk/sdk-integration/sdk-initialization/manual-initialization/android-sdk-initialization)
      - [Cordova](/developer-guide/cordova-sdk/sdk-integration/sdk-initialization/android-sdk-initialization)
      - [Unity](/developer-guide/unity-sdk/sdk-integration/sdk-initialization/manual-initialization/android)
