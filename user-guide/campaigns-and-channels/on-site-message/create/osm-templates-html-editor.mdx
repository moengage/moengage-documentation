...
Besides editing a pre-built template in code view, you can bring your own HTML into an On-site Messaging campaign. You can add your HTML in one of two ways:
...
In the **Content** step of On-site Messaging campaign creation, under **Start from scratch**, select **HTML Upload** or **HTML Zip Upload**.

![On-site Messaging Content step showing HTML Upload and HTML Zip Upload options under Start from scratch.](/images/osm-html-start-from-scratch.png)

### HTML Upload

Choose **HTML Upload** to write or paste your HTML in the **Code View** editor. To add images or other assets that your HTML references, use the upload option in the editor. When you build custom HTML, follow the click-tracking and close-button guidance in [Customize Templates in Code View](#customize-templates-in-code-view).
...
![Zip template dialog for uploading an HTML ZIP file to an On-site Messaging campaign.](/images/osm-html-zip-upload.png)
