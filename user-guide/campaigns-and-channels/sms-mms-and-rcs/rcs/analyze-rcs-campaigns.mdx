...
- **Event details**
  ...
  - **URL clicks**: This metric measures how many times users click a URL within an RCS message.
    ...
    <Note>
      If your RCS Carousel contains multiple Action URL suggestions across its cards, all URLs from all cards are listed together, each showing its individual click count. This gives you a single view of your top-performing links across the entire carousel, rather than a per-card breakdown.
    </Note>
