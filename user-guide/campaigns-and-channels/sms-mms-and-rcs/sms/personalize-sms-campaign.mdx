...
For more information, refer to [Message Personalisation](/user-guide/campaigns-and-channels/getting-started/message-personalization/overview#user-properties).
