...
Moreover, the integration for AMP pages is different from the regular Web Push integration with MoEngage SDK. For more information, refer to [AMP Web Push Integration](/developer-guide/web-sdk/other-supported-web-sdk-integration/configure-and-integrate-amp-web-push). Please note that this is available only for **HTTPS** websites.
