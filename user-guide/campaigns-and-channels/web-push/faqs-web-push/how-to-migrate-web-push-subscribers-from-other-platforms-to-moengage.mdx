...
1. Integrate MoEngage SDK with your website. Please refer to the [integration document](https://www.moengage.com/docs/developer-guide/web-sdk/web-sdk-integration/basic-integration/web-sdk-integration) for steps to integrate the SDK.
