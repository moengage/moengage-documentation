...
Enter the Notification Title and Message and [personalize the Redirect URL](/user-guide/settings/account/security/overview) by entering "@" and selecting "URL" under Event Properties as described:
