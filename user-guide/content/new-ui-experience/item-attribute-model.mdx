...
description: "Use the item attribute model in MoEngage to build rule-based recommendations from catalog filters — promote by brand, category, price, or recency."
---
