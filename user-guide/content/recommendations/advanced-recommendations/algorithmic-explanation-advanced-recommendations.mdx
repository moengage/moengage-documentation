...
| --- | --- | --- |
| **Recommended Items**<br />(Similar Users) | Hierarchical Recurrent Neural Network (HRNN) | <ul><li>Product viewed items</li><li>Added to Cart items</li><li>Added to Wishlist items</li><li>Product purchased items</li><li>User properties</li></ul> |
