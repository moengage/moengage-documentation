...
Popular Items ranks the items with the highest overall interaction counts across your catalog. It is not personalized, so every user receives the same crowd-level list.
