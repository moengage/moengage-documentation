...
After the processing is complete, test the recommendation against a real user, a random sample, or a specific item. For more information, refer to [Test a Recommendation](/user-guide/content/recommendations/getting-started/test-a-recommendation).
