...
11. Click **Save**. A recommendation is created with a 'Processing' state on the Recommendations page. It can take a maximum of 24 hours for recommendations to be active. Before using this recommendation in a campaign, test it against a real user, a random sample, or a specific item, and fine-tune its filters live. For more information, refer to [Test a Recommendation](/user-guide/content/recommendations/getting-started/test-a-recommendation).  
