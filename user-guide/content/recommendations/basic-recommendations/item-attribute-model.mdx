...
![Configuring a geo-location rule by selecting a location catalog attribute, choosing the comparison point, and setting a radius](/images/recommendations-geo-location-rule.gif)
...
8. Now, you can set up either generic rules or targeted rules.
   ...
   - To create a targeted rule, choose the relevant item attribute in the **Item where** drop-down list and select the **User Property** option.  
     **Note:** Ensure that the defined item attribute(s) and user property(s) carry a similar type of information.
