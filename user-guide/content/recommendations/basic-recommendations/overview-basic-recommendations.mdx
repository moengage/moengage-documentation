...
The user action recommendations can be generated based on the event data from the past 30 days, for the event(s) configuration in [user action mapping](/user-guide/content/recommendations/prerequisites/map-user-actions-settings).
