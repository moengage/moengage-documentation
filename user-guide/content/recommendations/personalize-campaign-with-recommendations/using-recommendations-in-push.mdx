...
4. Click **Periodic** campaign, and you can follow the same steps for any other push campaign type. For more information about delivery types, refer to [Delivery Types](/user-guide/campaigns-and-channels/getting-started/introduction/delivery-types-moengage-channels). <img src="/images/push-rec-delivery-type.png" />
