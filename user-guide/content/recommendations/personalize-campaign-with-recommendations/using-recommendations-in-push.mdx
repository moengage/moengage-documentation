...
1. On the sidebar menu in MoEngage, hover over the Engage menu item <img alt="Screenshot 2025-06-04 at 4.32.53 PM.png" src="/images/push-rec-engage-menu.png" /> . The **Engage** menu appears.
...
4. Click **Periodic** campaign, and you can follow the same steps for any other push campaign type. For more information about delivery types, refer to [Delivery Types](/user-guide/campaigns-and-channels/getting-started/introduction/delivery-types-moengage-channels). <img src="/images/moengage_ff7060.png" />
