...
<Note>
  In a workspace with multiple projects, a computed trait is created as a global user attribute. It appears under **User property** for every project, regardless of which project's events you built it from. For more information, refer to [Computed Traits in a Multi-Project Portfolio](/user-guide/data/computed-traits/computed-traits-overview#computed-traits-in-a-multi-project-portfolio).
</Note>
