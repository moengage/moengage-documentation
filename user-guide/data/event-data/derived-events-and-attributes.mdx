...
| Offering Clicked | Tracked when an offering is clicked by the user. | Android, iOS, Web |
| Offering Shown | Tracked when an offering is shown by the user. | Android, iOS, Web |
