...
| Notification Sent Android | Tracked when the Notification sending service accepts to send the notification on an Android device. This event is not enabled by default. To enable it, contact your MoEngage account team. | Android |
