...
<Info>
  - Some MoEngage-tracked events or system events (e.g., App/Site opened) have device information tracked as [event properties](/user-guide/data/event-data/derived-events-and-attributes#event-properties). Such event properties are available for analysis and segmentation.
