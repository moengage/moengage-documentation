...
<Tabs>
  <Tab title="OpenShare (Zero-Copy Sharing)">
    ...
    **Step 3: Configure Your Export**
    ...
    3. Create the export by following [Step 2: Add a New Databricks Export on the MoEngage App Marketplace](/user-guide/data/exports/events/data-warehouse/databricks-exports#step-2-add-a-new-databricks-export-on-the-moengage-app-marketplace).
  ...
  <Tab title="Direct Export">
    ...
    **Step 2: Add the Export on the App Marketplace**
    ...
    Continue with [Step 2: Add a New Databricks Export on the MoEngage App Marketplace](/user-guide/data/exports/events/data-warehouse/databricks-exports#step-2-add-a-new-databricks-export-on-the-moengage-app-marketplace), below.
  </Tab>
</Tabs>
