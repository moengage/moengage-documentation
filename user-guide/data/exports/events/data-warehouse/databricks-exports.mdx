...
<Accordion title="Can I rename the columns or tables in the OpenSharing catalog?">
  No. The schema is standardized and custom naming is not supported. You choose which events and attributes to export during configuration, as described in Step 3 of the OpenSharing setup.
</Accordion>
