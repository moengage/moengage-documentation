...
<Tabs>
  <Tab title="OpenShare (Zero-Copy Sharing)">
    ...
    **Step 2: Accept the Share**
    ...
    After MoEngage provisions the share, which usually takes up to seven business days, your CSM sends you the name of your data share. To accept the share, perform the following steps:
    ...
    **Step 3: Configure Your Export**
    ...
    4. Create the export as described in [Add a New Databricks Export on the MoEngage App Marketplace](/user-guide/data/exports/events/data-warehouse/databricks-exports#step-2-add-a-new-databricks-export-on-the-moengage-app-marketplace).

    Two things differ when you use OpenShare:

    - MoEngage does not prompt you for a connection, because OpenShare provisions it for you. You are not asked for service principal credentials or write access.
