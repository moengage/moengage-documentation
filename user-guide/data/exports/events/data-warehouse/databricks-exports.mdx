...
<Tabs>
  <Tab title="OpenShare (Zero-Copy Sharing)">
    ...
    **Step 3: Configure Your Export**
    ...
    3. Create the export by following the steps in the **Direct Export** tab of [Set Up Your Export](/user-guide/data/exports/events/data-warehouse/databricks-exports#set-up-your-export), starting from **Step 2: Add a New Databricks Export on the MoEngage App Marketplace**.
