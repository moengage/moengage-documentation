...
In the **Segment** \> [Manage Segments page](/user-guide/segment/segment-operations/manage-segments), select a Custom Segment and click **Sync Segment** in the action drop-down list.
