...
description: "Secure your file imports with PGP encryption in MoEngage. Set up public and private key pairs for encrypted S3 and SFTP data transfers safely."
---
...
<img src="/images/moengage_561689.png" />
...
```
gpg --import 
gpg --encrypt --sign --armor -r demo@example.com 
```
