...
<CardGroup cols={2}>
  ...
  <Card title="Set Up a Data Warehouse Import" href="/user-guide/data/imports/setting-up-a-dw-import" icon="database">
  ...
  <Card title="Auxiliary Data" href="/user-guide/data/imports/auxiliary-data-import" icon="table">
