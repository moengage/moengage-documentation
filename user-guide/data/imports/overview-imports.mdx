...
To see per-file details, rows in file, users created/updated/failed, events added/failed, aux data added/failed, and rows skipped, open the three-dot Actions menu and select **View Details**. You can export a copy of an imported file for up to 60 days. Keep your own copy of the files you import, because re-downloading a file from MoEngage is time-limited and not guaranteed.
