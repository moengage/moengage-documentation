...
- **Auxiliary Data**: Supplementary user data ingested temporarily. Auxiliary Data has its own setup — see [Auxiliary Data](/user-guide/data/imports/auxiliary-data).
