...
<Tabs>
  <Tab title="Amazon S3">
    ...
    <img src="/images/s3-imports-select-connection.png" alt="S3 connection, file type, folder path, and encryption options" />
  </Tab>
  <Tab title="SFTP">
    ...
    <img src="/images/moengage_84ac18.png" alt="SFTP connection, folder URL, and encryption fields" />
  </Tab>
</Tabs>
