...
<Tabs>
  <Tab title="Amazon S3">
    ...
    2. In the **S3 access key** and **S3 secret key** boxes, enter the credentials MoEngage uses to connect to the bucket.
    3. In the **Region** list, select the region your bucket is hosted in. (Optional)
    4. In the **Folder path** box, enter the path of the folder that holds your files, without a trailing slash.
    5. To import PGP-encrypted files, select **Is your file encrypted?** and provide your private **Decryption key**, optional public **Signing key**, and **Key passphrase**.
