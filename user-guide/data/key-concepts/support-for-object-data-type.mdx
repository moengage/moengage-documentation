...
| **Max Object-type Attributes** | By default, MoEngage allows a maximum of ten user properties and five event properties as Object data types. <br /> That is, ten user property objects and five event property objects totaling 15 object attributes in a workspace. |
...
1. Navigate to your MoEngage dashboard and click **Settings** \> **Analytics and Data** \> **Data management** \> **User properties** or **Events**.
2. Select the user property of the Object data type or search for one using the search bar. <img src="/images/moengage_f02bfe.png" />
...
- You can pin data type as Object or Array of Object for any custom user or event property.
...
4. From the User Profile page, go to the **Activity Info** tab, where you can view all your events and event properties in the object type section.
...
User data export (the **Export Users** action on a segment) does not support Object data-type attributes. If you export a segment with an Object or array-of-objects attribute selected, that attribute is exported as invalid or incomplete JSON and cannot be reliably parsed, because the export pipeline does not support Object data types. For more information on exporting users from a segment, refer to [Manage Segments](/user-guide/segment/create-segments/manage-segments#actions-on-custom-segments).
