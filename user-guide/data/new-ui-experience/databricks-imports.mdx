...
Just like new events, you can also create a new user property. To do so:
...
3. In the **Data type** list, select a data type. You can edit this and existing attributes from the [Data Management](/user-guide/settings/data-management/overview-data-management#event-tab) page.
   <Note>
     The newly created user properties will not appear on the **Data Management** page until the initial import is successful.
   </Note>
