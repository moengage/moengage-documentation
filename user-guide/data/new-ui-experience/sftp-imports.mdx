---
title: "SFTP Imports"
description: "Import users, events, and auxiliary data into MoEngage from your SFTP server. Covers setup for registered users, anonymous users, and events."
---
...
2. Click **Data imports**.  
    <img alt="Data imports.png"  src="/images/moengage_7b8dd1.png"  />
3. Click **+ Import**, and then select your source to create a new import for either **Users** or **Events**.

   <img alt="ImportDashboard.png" src="/images/moengage_7ea95b.png" />
...
4. Click the **SFTP tile** and click **Continue**.  
    <img alt="SFTP_IMports.png"  src="/images/moengage_345d66.png"  />
...
<img alt="SFTPRegisteredUser.png"  src="/images/moengage_53c849.png"  />

Choose which one you want to import. Both registered users import and anonymous users import expect different file names. Refer to the [Naming Conventions](/user-guide/data/imports/overview/overview-imports) section for more information.

#### **Event Imports**

For Event imports, you will now have the option to select which event it is that you want to import:

<img alt="SFTPEventsSetup.png"  src="/images/moengage_6f6644.png"  />
...
<img alt="IMport_Popup.png"  src="/images/moengage_fafedd.png"  />

In the above example, "App/Site Opened" is the Display Name of the chosen event and its Event Name is `MOE_APP_OPENED`, so the file names should begin with `MOE_APP_OPENED_`. Refer to the [Naming Conventions](/user-guide/data/imports/overview/overview-imports) section for more information.

You can also create a new event by clicking on the "+ Create event" option at the end of the dropdown:

<img alt="CreateNewEvent.png"  src="/images/moengage_43bb91.png"  />
...
<img  src="/images/moengage_84ac18.png"  />

### Import Name

<img alt="ImportName.png"  src="/images/moengage_af21ec.png"  />

Enter a name for this import to identify it on the Imports Dashboard easily.

### File configurations

<img alt="FileNameConfig.png" src="/images/moengage_19ba9f.png" />

Select the DateTime format that will be in your file name. As per the [Naming Conventions](/user-guide/data/imports/overview/overview-imports) defined above, your file name should end with `_.csv`. [Refer to the table](/user-guide/data/imports/overview/overview-imports) provided earlier to see which DateTime formats we support. The info message below will update according to your chosen DateTime format so that you can easily cross-verify if your files names are as per expectations.
...
<img alt="FileNameConfig_1.png" src="/images/moengage_42a05d.png" />
...
<img alt="CreateIMport_Step1.png"  src="/images/moengage_d02c37.png"  />
...
<img alt="MapColumns.png" src="/images/moengage_c60bc9.png" />
...
<img alt="MapColumns (1).png" src="/images/moengage_d05b58.png" />
...
<img alt="UploadMapping_1.png"  src="/images/moengage_ca6cf0.png"  />
...
<img alt="CreateNewAttributes (1).png" src="/images/moengage_e181f3.png" />

Any columns with non-MoEngage attributes will be left blank, and you can either manually map the column or create a new attribute for it. Make sure your manifest file follows the [expected conventions](/user-guide/data/imports/overview/overview-imports) as mentioned.
...
<img alt="SendImportStatus.png" src="/images/moengage_10b298.png" />
...
<img alt="Frequency.png"  src="/images/moengage_766c90.png"  />
...
For each run, MoEngage will try to fetch a file with the configured [DateTime format](/user-guide/data/imports/overview/overview-imports), so ensure your [file names](/user-guide/data/imports/overview/overview-imports) are configured properly.
