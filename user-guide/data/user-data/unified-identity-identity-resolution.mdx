...
Merge Caps:
  ...
  - For chained (transitive) merges, a strict **100-event limit** applies to events carried over from each deleted profile. For more information refer to events note under [Impact of Merging Users](/user-guide/data/user-data/unified-identity-identity-resolution#impact-of-merging-users).
