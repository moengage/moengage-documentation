...
1. In the **Basic details** section:
   ...
   - **Purpose**: Briefly explain what this Agent is intended to achieve (for example, "Maximize re-engagement for dormant users"). <img src="/images/moengage_509d0f.png" />
