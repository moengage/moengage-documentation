...
- [Step 2: Content (Targeting and Optimization)](/user-guide/decisioning/campaign-decisioning/create-a-campaign-decisioning-agent#step-2-content)
...
1. In the **Eligibility and Exclusion** section, you can select the target audience for your offering using the following segmentation filters:
   <Tabs>
     <Tab title="All Users">
       This filter option makes the offering eligible for all users. No further filtering can be applied. <img src="/images/moengage_aae208.png" alt="all users.png" />
     </Tab>
     <Tab title="Filter by User Property">
       ...
       3. Click **\+ Nested Filter** to add a filter to create nested AND or OR conditions. (This is optional) For more information, refer to [Create Segments](/user-guide/segment/segment-operations/rule-based-filter-segments). <img src="/images/moengage_2b6171.png" alt="user property.png" />
     </Tab>
     <Tab title="Filter by User Behavior">
       ...
       6. Click **\+ Nested Filter** to add a filter to create nested AND or OR conditions. (This is optional) For more information, refer to [Create Segments](/user-guide/segment/segment-operations/rule-based-filter-segments). <img src="/images/moengage_4223e1.png" alt="user behavior.png" />
     </Tab>
     <Tab title="Filter by User Affinity">
       ...
       5. Click **\+ Nested Filter** to add a filter to create nested AND or OR conditions. (This is optional) For more information, refer to [Create Segments](/user-guide/segment/segment-operations/rule-based-filter-segments). <img src="/images/moengage_7b301a.png" alt="5.png" />
     </Tab>
     <Tab title="Filter by Custom Segment">
       ...
       2. Click **\+ Nested Filter** to add a filter to create nested AND or OR conditions. (This is optional) For more information, refer to [Custom Segments](/user-guide/segment/segment-operations/custom-segments). <img src="/images/moengage_e871dc.png" alt="custom segment.png" />
     </Tab>
   </Tabs>
2. **Optimization Preference**: Adjust the slider to define how the AI balances learning versus performance:
   ...
   - **Low/No Exploration**: The AI relies on existing data to maximize results. This is ideal for established campaigns. <img src="/images/moengage_6365f0.png" />
