...
- Create one or more Offering attributes. For more information, refer to [Create Offering attribute](/user-guide/decisioning/offer-decisioning/offerings/create-offering-attributes).
- Assign them to offerings during offering creation. For more information, refer to [Create Offerings](/user-guide/decisioning/offer-decisioning/offerings/create-offerings).
- Use them in a Custom Formula ranking strategy within a Decision Policy. For more information, refer to [Custom Formula Ranking Strategy](/user-guide/decisioning/offer-decisioning/decision-policy/ranking-strategy/custom-formula-ranking-strategy).