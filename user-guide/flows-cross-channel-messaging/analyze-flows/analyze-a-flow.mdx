...
![Flow canvas with each stage showing its entered, current, drops and exits counts, along with the channel and conversion metrics](/images/flows-canvas-view-stage-stats.gif)
