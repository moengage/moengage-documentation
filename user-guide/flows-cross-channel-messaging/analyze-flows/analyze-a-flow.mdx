...
- **Drops** - This tab lists reasons for all drop-offs, an explanation for each drop-off reason, the total drop-offs due to this reason, and the percentage of all drop-offs. When you expand a drop-off reason, you will see the stage type and stage name from which users were dropped off. When you move active users to a new version, this tab also lists the users who had no defined path to move to in the new version. <img src="/images/moengage_e62a9e.png" alt="10.png" />
