...
| Condition Stage | For a condition stage, you can view the Status, evaluation start time, evaluation ending time, defined conditions, and entry/exit information. | For a condition stage, the information about which condition the user didn't meet(has done an event or user property check or criteria for conditional split) and the entry/exit information will be available. |
