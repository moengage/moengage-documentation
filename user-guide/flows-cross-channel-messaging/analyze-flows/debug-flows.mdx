...
7. You can specify a date range to select the attempts/entries of the user between a specific timeframe by clicking the <img alt="Filter_Icon.png" src="/images/moengage_32350c.png" /> (filter icon) and specifying the date range in the date field. The options available are _Yesterday_, _Last Week_, _Last Month_, and _Custom Range_. **Note**: You cannot look back at a date range greater than 7 days from the current date for debugging.
