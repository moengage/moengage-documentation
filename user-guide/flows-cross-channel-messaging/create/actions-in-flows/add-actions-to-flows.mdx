...
- Click **\+** and do one of the following to add the campaigns.
  - Click the category that the channel belongs to.
    ...
    | <img src="/images/moengage_65ca3e.png" alt="Add via Category.gif" /> |  |
    <Info>
      The five frequently used stages are displayed under the **Frequently Used** section on the **All stages** tab. The list of available stages changes dynamically based on your workspace. Click the required stage to add it to the flow. <img src="/images/moengage_88a186.png" alt="image.png" />
    </Info>
  - Click the **Actions** tab. <img src="/images/moengage_96ff21.png" alt="Moving_to_Action_tab.gif" />
  - Search for the campaigns directly via the Search bar. <img src="/images/moengage_7b976a.png" alt="Search_to_Add.gif" />
...
<Tabs>
  ...
  <Tab title="RCS">
    ...
    - **Action conditions:**
      ...
      - RCS clicked <img src="/images/moengage_010dcd.png" alt="rcs metrics.png" />
...
<Tabs>
  ...
  <Tab title="Copy a Branch">
    ...
    When you click on the copy icon, the following message is displayed in the lower right corner of the canvas. <img src="/images/moengage_339839.png" alt="Copy and paste 2.png" /> 2. Hover over the place where you want to paste the branch and click on the '\+' icon. You will see an app drawer where the name of the copied branch is displayed.
