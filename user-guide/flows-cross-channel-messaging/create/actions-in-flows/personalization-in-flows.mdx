...
4. Select the desired attribute from the **Flow Attributes** section.
   ...
   <img src="/images/flow-attributes-personalization.png" alt="The Connector Personalization window with the Flow Attributes section in the Select attribute list" />
5. Click **Done**.
