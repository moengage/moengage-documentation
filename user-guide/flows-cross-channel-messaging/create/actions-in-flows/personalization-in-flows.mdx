...
You can personalize a message with meta-information about the flow itself, such as its name, ID, and the stage the user is in, and pass those details to external systems like Connected Apps and Connectors.
