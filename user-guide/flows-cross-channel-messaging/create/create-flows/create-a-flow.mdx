...
<Tabs>
  ...
  <Tab title="Filter by User Affinity">
    ...
    4. Click **\+ Attributes** to add more attributes to the filter. For more information, refer to [Create Segments](/user-guide/segment/segment-operations/rule-based-filter-segments) <img src="/images/moengage_e55a72.png" alt="4.png" />
  </Tab>
