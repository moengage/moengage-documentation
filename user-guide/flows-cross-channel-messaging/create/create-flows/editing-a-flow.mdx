...
| Conditions (Check User Property/ Has done event/Conditional split) | <ul><li>Changing the condition of the stage or the branch</li><li>Changing the evaluation window</li><li>Adding or deleting a branch</li><li>Changing the order of branches</li></ul> |
