...
MoEngage retires a version this way only when you let its active users finish where they are. If you choose to move them into the new version when you publish, MoEngage stops that version instead and moves the active trips across. For more information, refer to [Publishing a new version](/user-guide/flows-cross-channel-messaging/create/create-flows/editing-a-flow#publishing-a-new-version).
