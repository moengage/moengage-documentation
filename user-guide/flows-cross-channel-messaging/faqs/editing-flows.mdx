...
**Note**: After you stop a flow, you cannot undo this action.
...
After all active trips are completed and there are no users left in the Flow, all child campaigns associated with the Flow will also be stopped.

MoEngage retires a version whether you let its active users finish where they are or move them into the new version. Because MoEngage does not always move every active trip at once, the version stays Retired while the remaining trips move across. For more information, refer to [Publishing a new version](/user-guide/flows-cross-channel-messaging/create/create-flows/editing-a-flow#publishing-a-new-version).

**Note**: After you retire a flow, you cannot undo this action.
