...
5. On the **Add condition** page, enter the following details:
   ...
   - **Traffic split**: This rule type allows you to select multiple senders and split traffic among them. For example, send 50% of the traffic to Sender A and 50% to Sender B. You can add up to five senders.
     \[Screenshot placeholder: Traffic split rule configuration showing 50% traffic routed to Sender A and 50% to Sender B]
   - **Sender fallback**: This rule type allows you to add multiple senders as fallback options. If sending through the primary sender fails, the system attempts to send through the next sender in the sequence. You can add up to five senders.
     \[Screenshot placeholder: Sender fallback rule configuration showing the primary sender and fallback senders]
