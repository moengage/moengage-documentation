...
description: "Create split URL tests in MoEngage Personalize to compare different webpage versions and find which variation drives the best results."
---
...
1. Navigate to **Create New** -\> **Experience** -\> **Web** or
2. Navigate to **Personalize** -\> **All Experiences** and click **\+ Experience** in the top right corner of the screen.
...
<Accordion title="Defining your Target Audience">
  ...
  3. **In-session attributes** - allow you to group website visitors based on specific conditions. You can add the following in-session attributes:
     ...
     | User Type | This field lets you segment users based on whether they are new or returning users. <br />**Note**: <br /> 1. If two users are using the same device and user 2 logs in after user 1, they would be considered a _returninguser_<br />   2. If a user logs in from the mobile browser and then logs in again from a desktop browser, the login from the desktop would be considered a _new user._ |
  ...
  ![AddAudience.gif](/images/moengage_7ee721.png)
</Accordion>
...
In this step, you personalize the webpage using MoEngage's WYSIWYG editor. [Refer to this article for a deep-dive on the editor capabilities.](https://moengage-user-guide.mintlify.app/user-guide/personalize/client-side-personalization/personalize-editor-capabilities)
...
| Metric | You must choose one metric among the following for Merlin AI to optimize on    <br />- Conversion <br />- Engagement <br />- Revenue |
...
![Screenshot 2025-01-29 at 11.56.27 AM.png](/images/moengage_5289d9.png)
...
![DeliverySchedule.png](/images/moengage_e1833d.png)
...
<img
  src="/images/moengage_af8235.png"
...
<img
  src="/images/moengage_e28bb5.png"
...
![AttributionWindow.png](/images/moengage_429d45.png)
