...
Accounts do have an identifier (event property) for different currencies. This identifier has to be used to filter the monetary events. Needless to say, Recency and frequency events should also be of that specific market or category, or business unit for which the monetary event is being analyzed.
