...
The MoEngage dashboard enables growth teams to create multiple types of segments, including [File Segments](/user-guide/segment/create-segments/file-segments), Rule-Based Segments, and Custom Segments. [Learn more about segment types.](/user-guide/segment/getting-started/types-of-segments)
