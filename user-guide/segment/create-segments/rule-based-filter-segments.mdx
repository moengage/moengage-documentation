...
<Tip>
  **Prerequisites**
  ...
  Rule-based segments are built from user attribute data and event data sent from your app or website. Before creating rule-based segments, ensure that MoEngage SDK integration and event tracking are complete. [More details on integration in our documentation.](/developer-guide/introduction)
