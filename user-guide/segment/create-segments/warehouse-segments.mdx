...
<Note>
  This article covers building a warehouse segment by writing SQL. If your warehouse tables are mapped in [Warehouse Schemas](/user-guide/settings/data-management/warehouse-schemas), you can also build one from dropdown filters without SQL. For more information, refer to [Simplified Warehouse Segments](/user-guide/segment/create-segments/simplified-warehouse-segments).
</Note>
