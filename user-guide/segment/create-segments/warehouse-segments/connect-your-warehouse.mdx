...
Select your warehouse below for the full setup steps.
...
- [Map Your Warehouse Schema](/user-guide/segment/create-segments/warehouse-segments/map-your-schema) — map your tables so marketers can build segments from dropdown filters.
