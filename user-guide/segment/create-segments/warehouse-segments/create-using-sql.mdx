...
2. Here, you can choose the data warehouse connection you [set up earlier](/user-guide/segment/create-segments/warehouse-segments/connect-your-warehouse), from the **Source** dropdown on the top.
...
Custom segments created this way are of type **Warehouse - SQL** and are listed on the All Segments page.
