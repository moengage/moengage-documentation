...
- Mark the users you want to reach as test users before you send the campaign from a Developer account. For more information, refer to [Test Users](/user-guide/getting-started/integration/test-users).
