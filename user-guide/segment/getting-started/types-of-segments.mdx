...
[Learn how to create and manage Segments.](/user-guide/segment/create-segments/manage-segments) You can also create and count custom segments through an AI assistant using the [MoEngage MCP segmentation tools](/user-guide/ai-and-intelligence/merlin-ai/moengage-mcp-segmentation-tools).
