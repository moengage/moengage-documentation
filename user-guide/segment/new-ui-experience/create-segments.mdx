...
MoEngage enables growth teams to create multiple types of segments, such as [Static Segments,](/user-guide/segment/segment-operations/file-segments)Rule Based Segments, Custom Segments & Live Segments. [Know more about the types of segments.](/user-guide/segment/basics-of-segmentation/types-of-segments)
