...
1. [Add a service principal in Databricks](/user-guide/segment/segment-operations/warehouse-segments)
2. [Assign a service principal to Databricks workspace](/user-guide/segment/segment-operations/warehouse-segments)
3. [Provide data reader access to the service principal](/user-guide/segment/segment-operations/warehouse-segments)
4. [Provide compute permissions on SQL warehouses to service principal](/user-guide/segment/segment-operations/warehouse-segments)
5. [Create a personal access token (PAT)](/user-guide/segment/segment-operations/warehouse-segments)
6. [Fetch the HTTP path and Hostname](/user-guide/segment/segment-operations/warehouse-segments)
7. [Connect Databricks on the App Marketplace](/user-guide/segment/segment-operations/warehouse-segments)
