...
The MoEngage dashboard enables growth teams to create multiple types of segments, including [File Segments](/user-guide/segment/segment-operations/file-segments), Rule-Based Segments, and Custom Segments. [Learn more about segment types.](/user-guide/segment/basics-of-segmentation/types-of-segments)
...
<Tip>
  **Prerequisites**
  ...
  If you want to create a segment without SDK integration, use [File Segments](/user-guide/segment/segment-operations/file-segments) or [Warehouse Segments](/user-guide/segment/segment-operations/warehouse-segments) instead.
</Tip>
...
[Custom Segments are explained in detail in this article](/user-guide/segment/segment-operations/manage-segments).
