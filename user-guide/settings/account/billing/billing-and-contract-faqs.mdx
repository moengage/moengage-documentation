...
<AccordionGroup>
  <Accordion title="Where can I see the products included in my contract?">
    Your contracted products, along with their subscription start and end dates, are listed in the **Subscribed products** section. For more information, refer to [Manage Subscription](/user-guide/settings/account/billing/manage-subscription#view-subscribed-products).
  </Accordion>
</AccordionGroup>
