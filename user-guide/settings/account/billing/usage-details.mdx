...
<Tabs>
  <Tab title="Billable MTUs">
    ...
    **Example**: 10,000 mobile-only users + 4,000 web-only users + 1,000 users active on both (counted once per platform, contributing 2,000) = 16,000 Total MTU.
    ...
    For your actual Total MTU and FUP, refer to [Manage Subscription](/user-guide/settings/account/billing/manage-subscription).
  ...
  <Tab title="Profile-Based">
    ...
    For your actual contracted rate and currency, refer to [Manage Subscription](/user-guide/settings/account/billing/manage-subscription).
  </Tab>
</Tabs>
