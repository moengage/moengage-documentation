...
<Tabs>
  ...
  <Tab title="Profile-Based">
    ...
    | Billing basis | Billed per profile tier, based on either All Profiles or Identified Profiles depending on your subscription. For more information, refer to [Manage Subscription](/user-guide/settings/account/billing/manage-subscription). |
