...
<Note>
  MoEngage supports JIT provisioning only for logins initiated via the Identity Provider (IdP-initiated login), which allows MoEngage to correctly identify the targeted workspace.
</Note>
