...
<Tabs>
  ...
  <Tab title="JumpCloud">
    ...
    **For group-based role assignment**, perform the following steps:
    ...
    1. On the left navigation menu, click **User Groups**.
    2. Click **\+** to create a new group, and in the **Name** box, type a name for the group.
    3. Click the **Users** tab, and add the users you want to assign this role to.
    4. Click the **Applications** tab, and select the check box for your MoEngage SAML application.
    5. Click **Save**.
    6. Open the group, and copy the **Group ID** from the browser's URL (you need this ID for the mapping expression in [Step 4.2](/user-guide/settings/account/security/system-for-cross-domain-identity-management-scim#step-4-2-map-the-attribute-in-export-attribute-mapping)).
