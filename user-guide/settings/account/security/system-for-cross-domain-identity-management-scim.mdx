...
<Tabs>
  ...
  <Tab title="JumpCloud">
    ...
    4. In **Mapping Type**, click **Direct Mapping (JSON Path)**. In **Source**, click **Custom User Attribute**, and replace the default value with the exact attribute name you used in [Step 4.1](/user-guide/settings/account/security/system-for-cross-domain-identity-management-scim#step-4-1-add-a-custom-attribute-to-the-user), for example, role.
