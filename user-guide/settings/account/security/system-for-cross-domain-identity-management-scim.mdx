...
<Tabs>
  ...
  <Tab title="JumpCloud">
    ...
    6. Turn the **Enable management of User Groups and Group Membership in this application** toggle on if you plan to assign roles based on JumpCloud groups.
    7. Click **Activate**.\
    ...
    <Info>
      If you do not turn on group management, JumpCloud provisions users individually, and you must set the role directly on each user's profile in [Step 4](/user-guide/settings/account/security/system-for-cross-domain-identity-management-scim#step-4-map-the-role-attribute).
    </Info>
