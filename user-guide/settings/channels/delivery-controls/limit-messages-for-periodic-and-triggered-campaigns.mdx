...
### Platform-level limit for Push and Cards
...
<AccordionGroup>
  ...
  <Accordion title="What happens if a message fails to deliver — does it still count against the limit?">
    It depends on the channel and connector type, since that determines whether **Sent** or **Delivered** is used to count the limit. For more information, refer to [How the limit is counted](/user-guide/settings/channels/delivery-controls/limit-messages-for-periodic-and-triggered-campaigns#how-the-limit-is-counted) above.
  </Accordion>
